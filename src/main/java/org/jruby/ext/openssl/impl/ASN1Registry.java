...
public class ASN1Registry {
    ...
    public static final int NID_hmac_md5 = 780;
    ...
    public static final int NID_hmac_sha1 = 781;
    ...
    public static final int NID_ecdsa_with_Recommended = 791;
    ...
    public static final int NID_ecdsa_with_Specified = 792;
    ...
    public static final int NID_ecdsa_with_SHA224 = 793;
    ...
    public static final int NID_ecdsa_with_SHA256 = 794;
    ...
    public static final int NID_ecdsa_with_SHA384 = 795;
    ...
    public static final int NID_ecdsa_with_SHA512 = 796;
    ...
    public static final int NID_id_PasswordBasedMAC = 782;
    ...
    public static final int NID_id_DHBasedMac = 783;
    ...
    public static final int NID_rsaesOaep = 919;
    ...
    public static final int NID_mgf1 = 911;
    ...
    public static final int NID_pSpecified = 935;
    ...
    public static final int NID_rsassaPss = 912;
    ...
    public static final int NID_id_ct_asciiTextWithCRLF = 787;
    ...
    public static final int NID_id_alg_PWRI_KEK = 893;
    ...
    public static final int NID_LocalKeySet = 856;
    ...
    public static final int NID_hmacWithMD5 = 797;
    ...
    public static final int NID_hmacWithSHA224 = 798;
    ...
    public static final int NID_hmacWithSHA256 = 799;
    ...
    public static final int NID_hmacWithSHA384 = 800;
    ...
    public static final int NID_hmacWithSHA512 = 801;
    ...
    public static final int NID_id_it_suppLangTags = 784;
    ...
    public static final int NID_id_on_permanentIdentifier = 858;
    ...
    public static final int NID_caRepository = 785;
    ...
    public static final int NID_postOfficeBox = 862;
    ...
    public static final int NID_physicalDeliveryOfficeName = 863;
    ...
    public static final int NID_teletexTerminalIdentifier = 866;
    ...
    public static final int NID_internationaliSDNNumber = 869;
    ...
    public static final int NID_registeredAddress = 870;
    ...
    public static final int NID_destinationIndicator = 871;
    ...
    public static final int NID_preferredDeliveryMethod = 872;
    ...
    public static final int NID_presentationAddress = 873;
    ...
    public static final int NID_authorityRevocationList = 882;
    ...
    public static final int NID_certificateRevocationList = 883;
    ...
    public static final int NID_crossCertificatePair = 884;
    ...
    public static final int NID_enhancedSearchGuide = 885;
    ...
    public static final int NID_protocolInformation = 886;
    ...
    public static final int NID_supportedAlgorithms = 890;
    ...
    public static final int NID_subject_directory_attributes = 769;
    ...
    public static final int NID_issuing_distribution_point = 770;
    ...
    public static final int NID_certificate_issuer = 771;
    ...
    public static final int NID_freshest_crl = 857;
    ...
    public static final int NID_anyExtendedKeyUsage = 910;
    ...
    public static final int NID_id_aes128_wrap = 788;
    ...
    public static final int NID_aes_128_gcm = 895;
    ...
    public static final int NID_aes_128_ccm = 896;
    ...
    public static final int NID_id_aes128_wrap_pad = 897;
    ...
    public static final int NID_id_aes192_wrap = 789;
    ...
    public static final int NID_aes_192_gcm = 898;
    ...
    public static final int NID_aes_192_ccm = 899;
    ...
    public static final int NID_id_aes192_wrap_pad = 900;
    ...
    public static final int NID_id_aes256_wrap = 790;
    ...
    public static final int NID_aes_256_gcm = 901;
    ...
    public static final int NID_aes_256_ccm = 902;
    ...
    public static final int NID_id_aes256_wrap_pad = 903;
    ...
    public static final int NID_id_GostR3411_94_with_GostR3410_2001 = 807;
    ...
    public static final int NID_id_GostR3411_94_with_GostR3410_94 = 808;
    ...
    public static final int NID_id_GostR3411_94 = 809;
    ...
    public static final int NID_id_HMACGostR3411_94 = 810;
    ...
    public static final int NID_id_GostR3410_2001 = 811;
    ...
    public static final int NID_id_GostR3410_94 = 812;
    ...
    public static final int NID_id_Gost28147_89_MAC = 815;
    ...
    public static final int NID_id_GostR3411_94_prf = 816;
    ...
    public static final int NID_id_GostR3410_2001DH = 817;
    ...
    public static final int NID_id_GostR3410_94DH = 818;
    ...
    public static final int NID_id_Gost28147_89_CryptoPro_KeyMeshing = 819;
    ...
    public static final int NID_id_Gost28147_89_None_KeyMeshing = 820;
    ...
    public static final int NID_id_GostR3411_94_TestParamSet = 821;
    ...
    public static final int NID_id_GostR3411_94_CryptoProParamSet = 822;
    ...
    public static final int NID_id_Gost28147_89_TestParamSet = 823;
    ...
    public static final int NID_id_Gost28147_89_CryptoPro_A_ParamSet = 824;
    ...
    public static final int NID_id_Gost28147_89_CryptoPro_B_ParamSet = 825;
    ...
    public static final int NID_id_Gost28147_89_CryptoPro_C_ParamSet = 826;
    ...
    public static final int NID_id_Gost28147_89_CryptoPro_D_ParamSet = 827;
    ...
    public static final int NID_id_Gost28147_89_CryptoPro_Oscar_1_1_ParamSet = 828;
    ...
    public static final int NID_id_Gost28147_89_CryptoPro_Oscar_1_0_ParamSet = 829;
    ...
    public static final int NID_id_Gost28147_89_CryptoPro_RIC_1_ParamSet = 830;
    ...
    public static final int NID_id_GostR3410_94_TestParamSet = 831;
    ...
    public static final int NID_id_GostR3410_94_CryptoPro_A_ParamSet = 832;
    ...
    public static final int NID_id_GostR3410_94_CryptoPro_B_ParamSet = 833;
    ...
    public static final int NID_id_GostR3410_94_CryptoPro_C_ParamSet = 834;
    ...
    public static final int NID_id_GostR3410_94_CryptoPro_D_ParamSet = 835;
    ...
    public static final int NID_id_GostR3410_94_CryptoPro_XchA_ParamSet = 836;
    ...
    public static final int NID_id_GostR3410_94_CryptoPro_XchB_ParamSet = 837;
    ...
    public static final int NID_id_GostR3410_94_CryptoPro_XchC_ParamSet = 838;
    ...
    public static final int NID_id_GostR3410_2001_TestParamSet = 839;
    ...
    public static final int NID_id_GostR3410_2001_CryptoPro_A_ParamSet = 840;
    ...
    public static final int NID_id_GostR3410_2001_CryptoPro_B_ParamSet = 841;
    ...
    public static final int NID_id_GostR3410_2001_CryptoPro_C_ParamSet = 842;
    ...
    public static final int NID_id_GostR3410_2001_CryptoPro_XchA_ParamSet = 843;
    ...
    public static final int NID_id_GostR3410_2001_CryptoPro_XchB_ParamSet = 844;
    ...
    public static final int NID_id_GostR3410_94_a = 845;
    ...
    public static final int NID_id_GostR3410_94_aBis = 846;
    ...
    public static final int NID_id_GostR3410_94_b = 847;
    ...
    public static final int NID_id_GostR3410_94_bBis = 848;
    ...
    public static final int NID_id_Gost28147_89_cc = 849;
    ...
    public static final int NID_id_GostR3410_94_cc = 850;
    ...
    public static final int NID_id_GostR3410_2001_cc = 851;
    ...
    public static final int NID_id_GostR3411_94_with_GostR3410_94_cc = 852;
    ...
    public static final int NID_id_GostR3411_94_with_GostR3410_2001_cc = 853;
    ...
    public static final int NID_id_GostR3410_2001_ParamSet_cc = 854;
    ...
    public static final int NID_camellia_128_cbc = 751;
    ...
    public static final int NID_camellia_192_cbc = 752;
    ...
    public static final int NID_camellia_256_cbc = 753;
    ...
    public static final int NID_id_camellia128_wrap = 907;
    ...
    public static final int NID_id_camellia192_wrap = 908;
    ...
    public static final int NID_id_camellia256_wrap = 909;
    ...
    public static final int NID_camellia_128_ecb = 754;
    ...
    public static final int NID_camellia_128_ofb128 = 766;
    ...
    public static final int NID_camellia_128_cfb128 = 757;
    ...
    public static final int NID_camellia_192_ecb = 755;
    ...
    public static final int NID_camellia_192_ofb128 = 767;
    ...
    public static final int NID_camellia_192_cfb128 = 758;
    ...
    public static final int NID_camellia_256_ecb = 756;
    ...
    public static final int NID_camellia_256_ofb128 = 768;
    ...
    public static final int NID_camellia_256_cfb128 = 759;
    ...
    public static final int NID_camellia_128_cfb1 = 760;
    ...
    public static final int NID_camellia_192_cfb1 = 761;
    ...
    public static final int NID_camellia_256_cfb1 = 762;
    ...
    public static final int NID_camellia_128_cfb8 = 763;
    ...
    public static final int NID_camellia_192_cfb8 = 764;
    ...
    public static final int NID_camellia_256_cfb8 = 765;

    public static final String SN_kisa = "KISA";
    public static final String LN_kisa = "kisa";
    public static final int NID_kisa = 773;
    ...
    public static final int NID_seed_ecb = 776;
    ...
    public static final int NID_seed_cbc = 777;
    ...
    public static final int NID_seed_cfb128 = 779;
    ...
    public static final int NID_seed_ofb128 = 778;
    ...
    public static final int NID_aes_128_cbc_hmac_sha1 = 916;
    ...
    public static final int NID_aes_192_cbc_hmac_sha1 = 917;
    ...
    public static final int NID_aes_256_cbc_hmac_sha1 = 918;
    ...
    public static final int NID_aes_128_cbc_hmac_sha256 = 948;
    ...
    public static final int NID_aes_192_cbc_hmac_sha256 = 949;
    ...
    public static final int NID_brainpoolP160r1 = 921;
    ...
    public static final int NID_brainpoolP160t1 = 922;
    ...
    public static final int NID_brainpoolP192r1 = 923;
    ...
    public static final int NID_brainpoolP192t1 = 924;
    ...
    public static final int NID_brainpoolP224r1 = 925;
    ...
    public static final int NID_brainpoolP224t1 = 926;
    ...
    public static final int NID_brainpoolP256r1 = 927;
    ...
    public static final int NID_brainpoolP256t1 = 928;
    ...
    public static final int NID_brainpoolP320r1 = 929;
    ...
    public static final int NID_brainpoolP320t1 = 930;
    ...
    public static final int NID_brainpoolP384r1 = 931;
    ...
    public static final int NID_brainpoolP384t1 = 932;
    ...
    public static final int NID_brainpoolP512r1 = 933;
    ...
    public static final int NID_brainpoolP512t1 = 934;
    ...
    public static final int NID_dhSinglePass_stdDH_sha1kdf_scheme = 936;
    ...
    public static final int NID_dhSinglePass_stdDH_sha224kdf_scheme = 937;
    ...
    public static final int NID_dhSinglePass_stdDH_sha256kdf_scheme = 938;
    ...
    public static final int NID_dhSinglePass_stdDH_sha384kdf_scheme = 939;
    ...
    public static final int NID_dhSinglePass_stdDH_sha512kdf_scheme = 940;
    ...
    public static final int NID_dhSinglePass_cofactorDH_sha1kdf_scheme = 941;
    ...
    public static final int NID_dhSinglePass_cofactorDH_sha224kdf_scheme = 942;
    ...
    public static final int NID_dhSinglePass_cofactorDH_sha256kdf_scheme = 943;
    ...
    public static final int NID_dhSinglePass_cofactorDH_sha384kdf_scheme = 944;
    ...
    public static final int NID_dhSinglePass_cofactorDH_sha512kdf_scheme = 945;
    ...
    public static final int NID_dh_std_kdf = 946;

    public static final String SN_dh_cofactor_kdf = "dh-cofactor-kdf";
    public static final int NID_dh_cofactor_kdf = 947;
    ...
    public static final int NID_ct_precert_scts = 951;
    ...
    public static final int NID_ct_precert_poison = 952;
    ...
    public static final int NID_ct_precert_signer = 953;
    ...
    public static final int NID_ct_cert_scts = 954;
    ...
    public static final int NID_jurisdictionLocalityName = 955;
    ...
    public static final int NID_jurisdictionStateOrProvinceName = 956;
    ...
    public static final int NID_jurisdictionCountryName = 957;
    ...
    static {
        OID_TO_NID.put( OBJ_undef, NID_undef );
        OID_TO_NID.put( OBJ_itu_t, NID_itu_t );
        OID_TO_NID.put( OBJ_ccitt, NID_ccitt );
        OID_TO_NID.put( OBJ_iso, NID_iso );
        OID_TO_NID.put( OBJ_joint_iso_itu_t, NID_joint_iso_itu_t );
        OID_TO_NID.put( OBJ_joint_iso_ccitt, NID_joint_iso_ccitt );
        OID_TO_NID.put( OBJ_member_body, NID_member_body );
        OID_TO_NID.put( OBJ_identified_organization, NID_identified_organization );
        OID_TO_NID.put( OBJ_hmac_md5, NID_hmac_md5 );
        OID_TO_NID.put( OBJ_hmac_sha1, NID_hmac_sha1 );
        OID_TO_NID.put( OBJ_certicom_arc, NID_certicom_arc );
        OID_TO_NID.put( OBJ_international_organizations, NID_international_organizations );
        OID_TO_NID.put( OBJ_wap, NID_wap );
        OID_TO_NID.put( OBJ_wap_wsg, NID_wap_wsg );
        OID_TO_NID.put( OBJ_selected_attribute_types, NID_selected_attribute_types );
        OID_TO_NID.put( OBJ_clearance, NID_clearance );
        OID_TO_NID.put( OBJ_ISO_US, NID_ISO_US );
        OID_TO_NID.put( OBJ_X9_57, NID_X9_57 );
        OID_TO_NID.put( OBJ_X9cm, NID_X9cm );
        OID_TO_NID.put( OBJ_dsa, NID_dsa );
        OID_TO_NID.put( OBJ_dsaWithSHA1, NID_dsaWithSHA1 );
        OID_TO_NID.put( OBJ_ansi_X9_62, NID_ansi_X9_62 );
        OID_TO_NID.put( OBJ_X9_62_prime_field, NID_X9_62_prime_field );
        OID_TO_NID.put( OBJ_X9_62_characteristic_two_field, NID_X9_62_characteristic_two_field );
        OID_TO_NID.put( OBJ_X9_62_id_characteristic_two_basis, NID_X9_62_id_characteristic_two_basis );
        OID_TO_NID.put( OBJ_X9_62_onBasis, NID_X9_62_onBasis );
        OID_TO_NID.put( OBJ_X9_62_tpBasis, NID_X9_62_tpBasis );
        OID_TO_NID.put( OBJ_X9_62_ppBasis, NID_X9_62_ppBasis );
        OID_TO_NID.put( OBJ_X9_62_id_ecPublicKey, NID_X9_62_id_ecPublicKey );
        OID_TO_NID.put( OBJ_X9_62_c2pnb163v1, NID_X9_62_c2pnb163v1 );
        OID_TO_NID.put( OBJ_X9_62_c2pnb163v2, NID_X9_62_c2pnb163v2 );
        OID_TO_NID.put( OBJ_X9_62_c2pnb163v3, NID_X9_62_c2pnb163v3 );
        OID_TO_NID.put( OBJ_X9_62_c2pnb176v1, NID_X9_62_c2pnb176v1 );
        OID_TO_NID.put( OBJ_X9_62_c2tnb191v1, NID_X9_62_c2tnb191v1 );
        OID_TO_NID.put( OBJ_X9_62_c2tnb191v2, NID_X9_62_c2tnb191v2 );
        OID_TO_NID.put( OBJ_X9_62_c2tnb191v3, NID_X9_62_c2tnb191v3 );
        OID_TO_NID.put( OBJ_X9_62_c2onb191v4, NID_X9_62_c2onb191v4 );
        OID_TO_NID.put( OBJ_X9_62_c2onb191v5, NID_X9_62_c2onb191v5 );
        OID_TO_NID.put( OBJ_X9_62_c2pnb208w1, NID_X9_62_c2pnb208w1 );
        OID_TO_NID.put( OBJ_X9_62_c2tnb239v1, NID_X9_62_c2tnb239v1 );
        OID_TO_NID.put( OBJ_X9_62_c2tnb239v2, NID_X9_62_c2tnb239v2 );
        OID_TO_NID.put( OBJ_X9_62_c2tnb239v3, NID_X9_62_c2tnb239v3 );
        OID_TO_NID.put( OBJ_X9_62_c2onb239v4, NID_X9_62_c2onb239v4 );
        OID_TO_NID.put( OBJ_X9_62_c2onb239v5, NID_X9_62_c2onb239v5 );
        OID_TO_NID.put( OBJ_X9_62_c2pnb272w1, NID_X9_62_c2pnb272w1 );
        OID_TO_NID.put( OBJ_X9_62_c2pnb304w1, NID_X9_62_c2pnb304w1 );
        OID_TO_NID.put( OBJ_X9_62_c2tnb359v1, NID_X9_62_c2tnb359v1 );
        OID_TO_NID.put( OBJ_X9_62_c2pnb368w1, NID_X9_62_c2pnb368w1 );
        OID_TO_NID.put( OBJ_X9_62_c2tnb431r1, NID_X9_62_c2tnb431r1 );
        OID_TO_NID.put( OBJ_X9_62_prime192v1, NID_X9_62_prime192v1 );
        OID_TO_NID.put( OBJ_X9_62_prime192v2, NID_X9_62_prime192v2 );
        OID_TO_NID.put( OBJ_X9_62_prime192v3, NID_X9_62_prime192v3 );
        OID_TO_NID.put( OBJ_X9_62_prime239v1, NID_X9_62_prime239v1 );
        OID_TO_NID.put( OBJ_X9_62_prime239v2, NID_X9_62_prime239v2 );
        OID_TO_NID.put( OBJ_X9_62_prime239v3, NID_X9_62_prime239v3 );
        OID_TO_NID.put( OBJ_X9_62_prime256v1, NID_X9_62_prime256v1 );
        OID_TO_NID.put( OBJ_ecdsa_with_SHA1, NID_ecdsa_with_SHA1 );
        OID_TO_NID.put( OBJ_ecdsa_with_Recommended, NID_ecdsa_with_Recommended );
        OID_TO_NID.put( OBJ_ecdsa_with_Specified, NID_ecdsa_with_Specified );
        OID_TO_NID.put( OBJ_ecdsa_with_SHA224, NID_ecdsa_with_SHA224 );
        OID_TO_NID.put( OBJ_ecdsa_with_SHA256, NID_ecdsa_with_SHA256 );
        OID_TO_NID.put( OBJ_ecdsa_with_SHA384, NID_ecdsa_with_SHA384 );
        OID_TO_NID.put( OBJ_ecdsa_with_SHA512, NID_ecdsa_with_SHA512 );
        OID_TO_NID.put( OBJ_secp112r1, NID_secp112r1 );
        OID_TO_NID.put( OBJ_secp112r2, NID_secp112r2 );
        OID_TO_NID.put( OBJ_secp128r1, NID_secp128r1 );
        OID_TO_NID.put( OBJ_secp128r2, NID_secp128r2 );
        OID_TO_NID.put( OBJ_secp160k1, NID_secp160k1 );
        OID_TO_NID.put( OBJ_secp160r1, NID_secp160r1 );
        OID_TO_NID.put( OBJ_secp160r2, NID_secp160r2 );
        OID_TO_NID.put( OBJ_secp192k1, NID_secp192k1 );
        OID_TO_NID.put( OBJ_secp224k1, NID_secp224k1 );
        OID_TO_NID.put( OBJ_secp224r1, NID_secp224r1 );
        OID_TO_NID.put( OBJ_secp256k1, NID_secp256k1 );
        OID_TO_NID.put( OBJ_secp384r1, NID_secp384r1 );
        OID_TO_NID.put( OBJ_secp521r1, NID_secp521r1 );
        OID_TO_NID.put( OBJ_sect113r1, NID_sect113r1 );
        OID_TO_NID.put( OBJ_sect113r2, NID_sect113r2 );
        OID_TO_NID.put( OBJ_sect131r1, NID_sect131r1 );
        OID_TO_NID.put( OBJ_sect131r2, NID_sect131r2 );
        OID_TO_NID.put( OBJ_sect163k1, NID_sect163k1 );
        OID_TO_NID.put( OBJ_sect163r1, NID_sect163r1 );
        OID_TO_NID.put( OBJ_sect163r2, NID_sect163r2 );
        OID_TO_NID.put( OBJ_sect193r1, NID_sect193r1 );
        OID_TO_NID.put( OBJ_sect193r2, NID_sect193r2 );
        OID_TO_NID.put( OBJ_sect233k1, NID_sect233k1 );
        OID_TO_NID.put( OBJ_sect233r1, NID_sect233r1 );
        OID_TO_NID.put( OBJ_sect239k1, NID_sect239k1 );
        OID_TO_NID.put( OBJ_sect283k1, NID_sect283k1 );
        OID_TO_NID.put( OBJ_sect283r1, NID_sect283r1 );
        OID_TO_NID.put( OBJ_sect409k1, NID_sect409k1 );
        OID_TO_NID.put( OBJ_sect409r1, NID_sect409r1 );
        OID_TO_NID.put( OBJ_sect571k1, NID_sect571k1 );
        OID_TO_NID.put( OBJ_sect571r1, NID_sect571r1 );
        OID_TO_NID.put( OBJ_wap_wsg_idm_ecid_wtls1, NID_wap_wsg_idm_ecid_wtls1 );
        OID_TO_NID.put( OBJ_wap_wsg_idm_ecid_wtls3, NID_wap_wsg_idm_ecid_wtls3 );
        OID_TO_NID.put( OBJ_wap_wsg_idm_ecid_wtls4, NID_wap_wsg_idm_ecid_wtls4 );
        OID_TO_NID.put( OBJ_wap_wsg_idm_ecid_wtls5, NID_wap_wsg_idm_ecid_wtls5 );
        OID_TO_NID.put( OBJ_wap_wsg_idm_ecid_wtls6, NID_wap_wsg_idm_ecid_wtls6 );
        OID_TO_NID.put( OBJ_wap_wsg_idm_ecid_wtls7, NID_wap_wsg_idm_ecid_wtls7 );
        OID_TO_NID.put( OBJ_wap_wsg_idm_ecid_wtls8, NID_wap_wsg_idm_ecid_wtls8 );
        OID_TO_NID.put( OBJ_wap_wsg_idm_ecid_wtls9, NID_wap_wsg_idm_ecid_wtls9 );
        OID_TO_NID.put( OBJ_wap_wsg_idm_ecid_wtls10, NID_wap_wsg_idm_ecid_wtls10 );
        OID_TO_NID.put( OBJ_wap_wsg_idm_ecid_wtls11, NID_wap_wsg_idm_ecid_wtls11 );
        OID_TO_NID.put( OBJ_wap_wsg_idm_ecid_wtls12, NID_wap_wsg_idm_ecid_wtls12 );
        OID_TO_NID.put( OBJ_cast5_cbc, NID_cast5_cbc );
        OID_TO_NID.put( OBJ_pbeWithMD5AndCast5_CBC, NID_pbeWithMD5AndCast5_CBC );
        OID_TO_NID.put( OBJ_id_PasswordBasedMAC, NID_id_PasswordBasedMAC );
        OID_TO_NID.put( OBJ_id_DHBasedMac, NID_id_DHBasedMac );
        OID_TO_NID.put( OBJ_rsadsi, NID_rsadsi );
        OID_TO_NID.put( OBJ_pkcs, NID_pkcs );
        OID_TO_NID.put( OBJ_pkcs1, NID_pkcs1 );
        OID_TO_NID.put( OBJ_rsaEncryption, NID_rsaEncryption );
        OID_TO_NID.put( OBJ_md2WithRSAEncryption, NID_md2WithRSAEncryption );
        OID_TO_NID.put( OBJ_md4WithRSAEncryption, NID_md4WithRSAEncryption );
        OID_TO_NID.put( OBJ_md5WithRSAEncryption, NID_md5WithRSAEncryption );
        OID_TO_NID.put( OBJ_sha1WithRSAEncryption, NID_sha1WithRSAEncryption );
        OID_TO_NID.put( OBJ_rsaesOaep, NID_rsaesOaep );
        OID_TO_NID.put( OBJ_mgf1, NID_mgf1 );
        OID_TO_NID.put( OBJ_pSpecified, NID_pSpecified );
        OID_TO_NID.put( OBJ_rsassaPss, NID_rsassaPss );
        OID_TO_NID.put( OBJ_sha256WithRSAEncryption, NID_sha256WithRSAEncryption );
        OID_TO_NID.put( OBJ_sha384WithRSAEncryption, NID_sha384WithRSAEncryption );
        OID_TO_NID.put( OBJ_sha512WithRSAEncryption, NID_sha512WithRSAEncryption );
        OID_TO_NID.put( OBJ_sha224WithRSAEncryption, NID_sha224WithRSAEncryption );
        OID_TO_NID.put( OBJ_pkcs3, NID_pkcs3 );
        OID_TO_NID.put( OBJ_dhKeyAgreement, NID_dhKeyAgreement );
        OID_TO_NID.put( OBJ_pkcs5, NID_pkcs5 );
        OID_TO_NID.put( OBJ_pbeWithMD2AndDES_CBC, NID_pbeWithMD2AndDES_CBC );
        OID_TO_NID.put( OBJ_pbeWithMD5AndDES_CBC, NID_pbeWithMD5AndDES_CBC );
        OID_TO_NID.put( OBJ_pbeWithMD2AndRC2_CBC, NID_pbeWithMD2AndRC2_CBC );
        OID_TO_NID.put( OBJ_pbeWithMD5AndRC2_CBC, NID_pbeWithMD5AndRC2_CBC );
        OID_TO_NID.put( OBJ_pbeWithSHA1AndDES_CBC, NID_pbeWithSHA1AndDES_CBC );
        OID_TO_NID.put( OBJ_pbeWithSHA1AndRC2_CBC, NID_pbeWithSHA1AndRC2_CBC );
        OID_TO_NID.put( OBJ_id_pbkdf2, NID_id_pbkdf2 );
        OID_TO_NID.put( OBJ_pbes2, NID_pbes2 );
        OID_TO_NID.put( OBJ_pbmac1, NID_pbmac1 );
        OID_TO_NID.put( OBJ_pkcs7, NID_pkcs7 );
        OID_TO_NID.put( OBJ_pkcs7_data, NID_pkcs7_data );
        OID_TO_NID.put( OBJ_pkcs7_signed, NID_pkcs7_signed );
        OID_TO_NID.put( OBJ_pkcs7_enveloped, NID_pkcs7_enveloped );
        OID_TO_NID.put( OBJ_pkcs7_signedAndEnveloped, NID_pkcs7_signedAndEnveloped );
        OID_TO_NID.put( OBJ_pkcs7_digest, NID_pkcs7_digest );
        OID_TO_NID.put( OBJ_pkcs7_encrypted, NID_pkcs7_encrypted );
        OID_TO_NID.put( OBJ_pkcs9, NID_pkcs9 );
        OID_TO_NID.put( OBJ_pkcs9_emailAddress, NID_pkcs9_emailAddress );
        OID_TO_NID.put( OBJ_pkcs9_unstructuredName, NID_pkcs9_unstructuredName );
        OID_TO_NID.put( OBJ_pkcs9_contentType, NID_pkcs9_contentType );
        OID_TO_NID.put( OBJ_pkcs9_messageDigest, NID_pkcs9_messageDigest );
        OID_TO_NID.put( OBJ_pkcs9_signingTime, NID_pkcs9_signingTime );
        OID_TO_NID.put( OBJ_pkcs9_countersignature, NID_pkcs9_countersignature );
        OID_TO_NID.put( OBJ_pkcs9_challengePassword, NID_pkcs9_challengePassword );
        OID_TO_NID.put( OBJ_pkcs9_unstructuredAddress, NID_pkcs9_unstructuredAddress );
        OID_TO_NID.put( OBJ_pkcs9_extCertAttributes, NID_pkcs9_extCertAttributes );
        OID_TO_NID.put( OBJ_ext_req, NID_ext_req );
        OID_TO_NID.put( OBJ_SMIMECapabilities, NID_SMIMECapabilities );
        OID_TO_NID.put( OBJ_SMIME, NID_SMIME );
        OID_TO_NID.put( OBJ_id_smime_mod, NID_id_smime_mod );
        OID_TO_NID.put( OBJ_id_smime_ct, NID_id_smime_ct );
        OID_TO_NID.put( OBJ_id_smime_aa, NID_id_smime_aa );
        OID_TO_NID.put( OBJ_id_smime_alg, NID_id_smime_alg );
        OID_TO_NID.put( OBJ_id_smime_cd, NID_id_smime_cd );
        OID_TO_NID.put( OBJ_id_smime_spq, NID_id_smime_spq );
        OID_TO_NID.put( OBJ_id_smime_cti, NID_id_smime_cti );
        OID_TO_NID.put( OBJ_id_smime_mod_cms, NID_id_smime_mod_cms );
        OID_TO_NID.put( OBJ_id_smime_mod_ess, NID_id_smime_mod_ess );
        OID_TO_NID.put( OBJ_id_smime_mod_oid, NID_id_smime_mod_oid );
        OID_TO_NID.put( OBJ_id_smime_mod_msg_v3, NID_id_smime_mod_msg_v3 );
        OID_TO_NID.put( OBJ_id_smime_mod_ets_eSignature_88, NID_id_smime_mod_ets_eSignature_88 );
        OID_TO_NID.put( OBJ_id_smime_mod_ets_eSignature_97, NID_id_smime_mod_ets_eSignature_97 );
        OID_TO_NID.put( OBJ_id_smime_mod_ets_eSigPolicy_88, NID_id_smime_mod_ets_eSigPolicy_88 );
        OID_TO_NID.put( OBJ_id_smime_mod_ets_eSigPolicy_97, NID_id_smime_mod_ets_eSigPolicy_97 );
        OID_TO_NID.put( OBJ_id_smime_ct_receipt, NID_id_smime_ct_receipt );
        OID_TO_NID.put( OBJ_id_smime_ct_authData, NID_id_smime_ct_authData );
        OID_TO_NID.put( OBJ_id_smime_ct_publishCert, NID_id_smime_ct_publishCert );
        OID_TO_NID.put( OBJ_id_smime_ct_TSTInfo, NID_id_smime_ct_TSTInfo );
        OID_TO_NID.put( OBJ_id_smime_ct_TDTInfo, NID_id_smime_ct_TDTInfo );
        OID_TO_NID.put( OBJ_id_smime_ct_contentInfo, NID_id_smime_ct_contentInfo );
        OID_TO_NID.put( OBJ_id_smime_ct_DVCSRequestData, NID_id_smime_ct_DVCSRequestData );
        OID_TO_NID.put( OBJ_id_smime_ct_DVCSResponseData, NID_id_smime_ct_DVCSResponseData );
        OID_TO_NID.put( OBJ_id_smime_ct_compressedData, NID_id_smime_ct_compressedData );
        OID_TO_NID.put( OBJ_id_ct_asciiTextWithCRLF, NID_id_ct_asciiTextWithCRLF );
        OID_TO_NID.put( OBJ_id_smime_aa_receiptRequest, NID_id_smime_aa_receiptRequest );
        OID_TO_NID.put( OBJ_id_smime_aa_securityLabel, NID_id_smime_aa_securityLabel );
        OID_TO_NID.put( OBJ_id_smime_aa_mlExpandHistory, NID_id_smime_aa_mlExpandHistory );
        OID_TO_NID.put( OBJ_id_smime_aa_contentHint, NID_id_smime_aa_contentHint );
        OID_TO_NID.put( OBJ_id_smime_aa_msgSigDigest, NID_id_smime_aa_msgSigDigest );
        OID_TO_NID.put( OBJ_id_smime_aa_encapContentType, NID_id_smime_aa_encapContentType );
        OID_TO_NID.put( OBJ_id_smime_aa_contentIdentifier, NID_id_smime_aa_contentIdentifier );
        OID_TO_NID.put( OBJ_id_smime_aa_macValue, NID_id_smime_aa_macValue );
        OID_TO_NID.put( OBJ_id_smime_aa_equivalentLabels, NID_id_smime_aa_equivalentLabels );
        OID_TO_NID.put( OBJ_id_smime_aa_contentReference, NID_id_smime_aa_contentReference );
        OID_TO_NID.put( OBJ_id_smime_aa_encrypKeyPref, NID_id_smime_aa_encrypKeyPref );
        OID_TO_NID.put( OBJ_id_smime_aa_signingCertificate, NID_id_smime_aa_signingCertificate );
        OID_TO_NID.put( OBJ_id_smime_aa_smimeEncryptCerts, NID_id_smime_aa_smimeEncryptCerts );
        OID_TO_NID.put( OBJ_id_smime_aa_timeStampToken, NID_id_smime_aa_timeStampToken );
        OID_TO_NID.put( OBJ_id_smime_aa_ets_sigPolicyId, NID_id_smime_aa_ets_sigPolicyId );
        OID_TO_NID.put( OBJ_id_smime_aa_ets_commitmentType, NID_id_smime_aa_ets_commitmentType );
        OID_TO_NID.put( OBJ_id_smime_aa_ets_signerLocation, NID_id_smime_aa_ets_signerLocation );
        OID_TO_NID.put( OBJ_id_smime_aa_ets_signerAttr, NID_id_smime_aa_ets_signerAttr );
        OID_TO_NID.put( OBJ_id_smime_aa_ets_otherSigCert, NID_id_smime_aa_ets_otherSigCert );
        OID_TO_NID.put( OBJ_id_smime_aa_ets_contentTimestamp, NID_id_smime_aa_ets_contentTimestamp );
        OID_TO_NID.put( OBJ_id_smime_aa_ets_CertificateRefs, NID_id_smime_aa_ets_CertificateRefs );
        OID_TO_NID.put( OBJ_id_smime_aa_ets_RevocationRefs, NID_id_smime_aa_ets_RevocationRefs );
        OID_TO_NID.put( OBJ_id_smime_aa_ets_certValues, NID_id_smime_aa_ets_certValues );
        OID_TO_NID.put( OBJ_id_smime_aa_ets_revocationValues, NID_id_smime_aa_ets_revocationValues );
        OID_TO_NID.put( OBJ_id_smime_aa_ets_escTimeStamp, NID_id_smime_aa_ets_escTimeStamp );
        OID_TO_NID.put( OBJ_id_smime_aa_ets_certCRLTimestamp, NID_id_smime_aa_ets_certCRLTimestamp );
        OID_TO_NID.put( OBJ_id_smime_aa_ets_archiveTimeStamp, NID_id_smime_aa_ets_archiveTimeStamp );
        OID_TO_NID.put( OBJ_id_smime_aa_signatureType, NID_id_smime_aa_signatureType );
        OID_TO_NID.put( OBJ_id_smime_aa_dvcs_dvc, NID_id_smime_aa_dvcs_dvc );
        OID_TO_NID.put( OBJ_id_smime_alg_ESDHwith3DES, NID_id_smime_alg_ESDHwith3DES );
        OID_TO_NID.put( OBJ_id_smime_alg_ESDHwithRC2, NID_id_smime_alg_ESDHwithRC2 );
        OID_TO_NID.put( OBJ_id_smime_alg_3DESwrap, NID_id_smime_alg_3DESwrap );
        OID_TO_NID.put( OBJ_id_smime_alg_RC2wrap, NID_id_smime_alg_RC2wrap );
        OID_TO_NID.put( OBJ_id_smime_alg_ESDH, NID_id_smime_alg_ESDH );
        OID_TO_NID.put( OBJ_id_smime_alg_CMS3DESwrap, NID_id_smime_alg_CMS3DESwrap );
        OID_TO_NID.put( OBJ_id_smime_alg_CMSRC2wrap, NID_id_smime_alg_CMSRC2wrap );
        OID_TO_NID.put( OBJ_id_alg_PWRI_KEK, NID_id_alg_PWRI_KEK );
        OID_TO_NID.put( OBJ_id_smime_cd_ldap, NID_id_smime_cd_ldap );
        OID_TO_NID.put( OBJ_id_smime_spq_ets_sqt_uri, NID_id_smime_spq_ets_sqt_uri );
        OID_TO_NID.put( OBJ_id_smime_spq_ets_sqt_unotice, NID_id_smime_spq_ets_sqt_unotice );
        OID_TO_NID.put( OBJ_id_smime_cti_ets_proofOfOrigin, NID_id_smime_cti_ets_proofOfOrigin );
        OID_TO_NID.put( OBJ_id_smime_cti_ets_proofOfReceipt, NID_id_smime_cti_ets_proofOfReceipt );
        OID_TO_NID.put( OBJ_id_smime_cti_ets_proofOfDelivery, NID_id_smime_cti_ets_proofOfDelivery );
        OID_TO_NID.put( OBJ_id_smime_cti_ets_proofOfSender, NID_id_smime_cti_ets_proofOfSender );
        OID_TO_NID.put( OBJ_id_smime_cti_ets_proofOfApproval, NID_id_smime_cti_ets_proofOfApproval );
        OID_TO_NID.put( OBJ_id_smime_cti_ets_proofOfCreation, NID_id_smime_cti_ets_proofOfCreation );
        OID_TO_NID.put( OBJ_friendlyName, NID_friendlyName );
        OID_TO_NID.put( OBJ_localKeyID, NID_localKeyID );
        OID_TO_NID.put( OBJ_ms_csp_name, NID_ms_csp_name );
        OID_TO_NID.put( OBJ_LocalKeySet, NID_LocalKeySet );
        OID_TO_NID.put( OBJ_x509Certificate, NID_x509Certificate );
        OID_TO_NID.put( OBJ_sdsiCertificate, NID_sdsiCertificate );
        OID_TO_NID.put( OBJ_x509Crl, NID_x509Crl );
        OID_TO_NID.put( OBJ_pbe_WithSHA1And128BitRC4, NID_pbe_WithSHA1And128BitRC4 );
        OID_TO_NID.put( OBJ_pbe_WithSHA1And40BitRC4, NID_pbe_WithSHA1And40BitRC4 );
        OID_TO_NID.put( OBJ_pbe_WithSHA1And3_Key_TripleDES_CBC, NID_pbe_WithSHA1And3_Key_TripleDES_CBC );
        OID_TO_NID.put( OBJ_pbe_WithSHA1And2_Key_TripleDES_CBC, NID_pbe_WithSHA1And2_Key_TripleDES_CBC );
        OID_TO_NID.put( OBJ_pbe_WithSHA1And128BitRC2_CBC, NID_pbe_WithSHA1And128BitRC2_CBC );
        OID_TO_NID.put( OBJ_pbe_WithSHA1And40BitRC2_CBC, NID_pbe_WithSHA1And40BitRC2_CBC );
        OID_TO_NID.put( OBJ_keyBag, NID_keyBag );
        OID_TO_NID.put( OBJ_pkcs8ShroudedKeyBag, NID_pkcs8ShroudedKeyBag );
        OID_TO_NID.put( OBJ_certBag, NID_certBag );
        OID_TO_NID.put( OBJ_crlBag, NID_crlBag );
        OID_TO_NID.put( OBJ_secretBag, NID_secretBag );
        OID_TO_NID.put( OBJ_safeContentsBag, NID_safeContentsBag );
        OID_TO_NID.put( OBJ_md2, NID_md2 );
        OID_TO_NID.put( OBJ_md4, NID_md4 );
        OID_TO_NID.put( OBJ_md5, NID_md5 );
        OID_TO_NID.put( OBJ_hmacWithMD5, NID_hmacWithMD5 );
        OID_TO_NID.put( OBJ_hmacWithSHA1, NID_hmacWithSHA1 );
        OID_TO_NID.put( OBJ_hmacWithSHA224, NID_hmacWithSHA224 );
        OID_TO_NID.put( OBJ_hmacWithSHA256, NID_hmacWithSHA256 );
        OID_TO_NID.put( OBJ_hmacWithSHA384, NID_hmacWithSHA384 );
        OID_TO_NID.put( OBJ_hmacWithSHA512, NID_hmacWithSHA512 );
        OID_TO_NID.put( OBJ_rc2_cbc, NID_rc2_cbc );
        OID_TO_NID.put( OBJ_rc4, NID_rc4 );
        OID_TO_NID.put( OBJ_des_ede3_cbc, NID_des_ede3_cbc );
        OID_TO_NID.put( OBJ_rc5_cbc, NID_rc5_cbc );
        OID_TO_NID.put( OBJ_ms_ext_req, NID_ms_ext_req );
        OID_TO_NID.put( OBJ_ms_code_ind, NID_ms_code_ind );
        OID_TO_NID.put( OBJ_ms_code_com, NID_ms_code_com );
        OID_TO_NID.put( OBJ_ms_ctl_sign, NID_ms_ctl_sign );
        OID_TO_NID.put( OBJ_ms_sgc, NID_ms_sgc );
        OID_TO_NID.put( OBJ_ms_efs, NID_ms_efs );
        OID_TO_NID.put( OBJ_ms_smartcard_login, NID_ms_smartcard_login );
        OID_TO_NID.put( OBJ_ms_upn, NID_ms_upn );
        OID_TO_NID.put( OBJ_idea_cbc, NID_idea_cbc );
        OID_TO_NID.put( OBJ_bf_cbc, NID_bf_cbc );
        OID_TO_NID.put( OBJ_id_pkix, NID_id_pkix );
        OID_TO_NID.put( OBJ_id_pkix_mod, NID_id_pkix_mod );
        OID_TO_NID.put( OBJ_id_pe, NID_id_pe );
        OID_TO_NID.put( OBJ_id_qt, NID_id_qt );
        OID_TO_NID.put( OBJ_id_kp, NID_id_kp );
        OID_TO_NID.put( OBJ_id_it, NID_id_it );
        OID_TO_NID.put( OBJ_id_pkip, NID_id_pkip );
        OID_TO_NID.put( OBJ_id_alg, NID_id_alg );
        OID_TO_NID.put( OBJ_id_cmc, NID_id_cmc );
        OID_TO_NID.put( OBJ_id_on, NID_id_on );
        OID_TO_NID.put( OBJ_id_pda, NID_id_pda );
        OID_TO_NID.put( OBJ_id_aca, NID_id_aca );
        OID_TO_NID.put( OBJ_id_qcs, NID_id_qcs );
        OID_TO_NID.put( OBJ_id_cct, NID_id_cct );
        OID_TO_NID.put( OBJ_id_ppl, NID_id_ppl );
        OID_TO_NID.put( OBJ_id_ad, NID_id_ad );
        OID_TO_NID.put( OBJ_id_pkix1_explicit_88, NID_id_pkix1_explicit_88 );
        OID_TO_NID.put( OBJ_id_pkix1_implicit_88, NID_id_pkix1_implicit_88 );
        OID_TO_NID.put( OBJ_id_pkix1_explicit_93, NID_id_pkix1_explicit_93 );
        OID_TO_NID.put( OBJ_id_pkix1_implicit_93, NID_id_pkix1_implicit_93 );
        OID_TO_NID.put( OBJ_id_mod_crmf, NID_id_mod_crmf );
        OID_TO_NID.put( OBJ_id_mod_cmc, NID_id_mod_cmc );
        OID_TO_NID.put( OBJ_id_mod_kea_profile_88, NID_id_mod_kea_profile_88 );
        OID_TO_NID.put( OBJ_id_mod_kea_profile_93, NID_id_mod_kea_profile_93 );
        OID_TO_NID.put( OBJ_id_mod_cmp, NID_id_mod_cmp );
        OID_TO_NID.put( OBJ_id_mod_qualified_cert_88, NID_id_mod_qualified_cert_88 );
        OID_TO_NID.put( OBJ_id_mod_qualified_cert_93, NID_id_mod_qualified_cert_93 );
        OID_TO_NID.put( OBJ_id_mod_attribute_cert, NID_id_mod_attribute_cert );
        OID_TO_NID.put( OBJ_id_mod_timestamp_protocol, NID_id_mod_timestamp_protocol );
        OID_TO_NID.put( OBJ_id_mod_ocsp, NID_id_mod_ocsp );
        OID_TO_NID.put( OBJ_id_mod_dvcs, NID_id_mod_dvcs );
        OID_TO_NID.put( OBJ_id_mod_cmp2000, NID_id_mod_cmp2000 );
        OID_TO_NID.put( OBJ_info_access, NID_info_access );
        OID_TO_NID.put( OBJ_biometricInfo, NID_biometricInfo );
        OID_TO_NID.put( OBJ_qcStatements, NID_qcStatements );
        OID_TO_NID.put( OBJ_ac_auditEntity, NID_ac_auditEntity );
        OID_TO_NID.put( OBJ_ac_targeting, NID_ac_targeting );
        OID_TO_NID.put( OBJ_aaControls, NID_aaControls );
        OID_TO_NID.put( OBJ_sbgp_ipAddrBlock, NID_sbgp_ipAddrBlock );
        OID_TO_NID.put( OBJ_sbgp_autonomousSysNum, NID_sbgp_autonomousSysNum );
        OID_TO_NID.put( OBJ_sbgp_routerIdentifier, NID_sbgp_routerIdentifier );
        OID_TO_NID.put( OBJ_ac_proxying, NID_ac_proxying );
        OID_TO_NID.put( OBJ_sinfo_access, NID_sinfo_access );
        OID_TO_NID.put( OBJ_proxyCertInfo, NID_proxyCertInfo );
        OID_TO_NID.put( OBJ_id_qt_cps, NID_id_qt_cps );
        OID_TO_NID.put( OBJ_id_qt_unotice, NID_id_qt_unotice );
        OID_TO_NID.put( OBJ_textNotice, NID_textNotice );
        OID_TO_NID.put( OBJ_server_auth, NID_server_auth );
        OID_TO_NID.put( OBJ_client_auth, NID_client_auth );
        OID_TO_NID.put( OBJ_code_sign, NID_code_sign );
        OID_TO_NID.put( OBJ_email_protect, NID_email_protect );
        OID_TO_NID.put( OBJ_ipsecEndSystem, NID_ipsecEndSystem );
        OID_TO_NID.put( OBJ_ipsecTunnel, NID_ipsecTunnel );
        OID_TO_NID.put( OBJ_ipsecUser, NID_ipsecUser );
        OID_TO_NID.put( OBJ_time_stamp, NID_time_stamp );
        OID_TO_NID.put( OBJ_OCSP_sign, NID_OCSP_sign );
        OID_TO_NID.put( OBJ_dvcs, NID_dvcs );
        OID_TO_NID.put( OBJ_id_it_caProtEncCert, NID_id_it_caProtEncCert );
        OID_TO_NID.put( OBJ_id_it_signKeyPairTypes, NID_id_it_signKeyPairTypes );
        OID_TO_NID.put( OBJ_id_it_encKeyPairTypes, NID_id_it_encKeyPairTypes );
        OID_TO_NID.put( OBJ_id_it_preferredSymmAlg, NID_id_it_preferredSymmAlg );
        OID_TO_NID.put( OBJ_id_it_caKeyUpdateInfo, NID_id_it_caKeyUpdateInfo );
        OID_TO_NID.put( OBJ_id_it_currentCRL, NID_id_it_currentCRL );
        OID_TO_NID.put( OBJ_id_it_unsupportedOIDs, NID_id_it_unsupportedOIDs );
        OID_TO_NID.put( OBJ_id_it_subscriptionRequest, NID_id_it_subscriptionRequest );
        OID_TO_NID.put( OBJ_id_it_subscriptionResponse, NID_id_it_subscriptionResponse );
        OID_TO_NID.put( OBJ_id_it_keyPairParamReq, NID_id_it_keyPairParamReq );
        OID_TO_NID.put( OBJ_id_it_keyPairParamRep, NID_id_it_keyPairParamRep );
        OID_TO_NID.put( OBJ_id_it_revPassphrase, NID_id_it_revPassphrase );
        OID_TO_NID.put( OBJ_id_it_implicitConfirm, NID_id_it_implicitConfirm );
        OID_TO_NID.put( OBJ_id_it_confirmWaitTime, NID_id_it_confirmWaitTime );
        OID_TO_NID.put( OBJ_id_it_origPKIMessage, NID_id_it_origPKIMessage );
        OID_TO_NID.put( OBJ_id_it_suppLangTags, NID_id_it_suppLangTags );
        OID_TO_NID.put( OBJ_id_regCtrl, NID_id_regCtrl );
        OID_TO_NID.put( OBJ_id_regInfo, NID_id_regInfo );
        OID_TO_NID.put( OBJ_id_regCtrl_regToken, NID_id_regCtrl_regToken );
        OID_TO_NID.put( OBJ_id_regCtrl_authenticator, NID_id_regCtrl_authenticator );
        OID_TO_NID.put( OBJ_id_regCtrl_pkiPublicationInfo, NID_id_regCtrl_pkiPublicationInfo );
        OID_TO_NID.put( OBJ_id_regCtrl_pkiArchiveOptions, NID_id_regCtrl_pkiArchiveOptions );
        OID_TO_NID.put( OBJ_id_regCtrl_oldCertID, NID_id_regCtrl_oldCertID );
        OID_TO_NID.put( OBJ_id_regCtrl_protocolEncrKey, NID_id_regCtrl_protocolEncrKey );
        OID_TO_NID.put( OBJ_id_regInfo_utf8Pairs, NID_id_regInfo_utf8Pairs );
        OID_TO_NID.put( OBJ_id_regInfo_certReq, NID_id_regInfo_certReq );
        OID_TO_NID.put( OBJ_id_alg_des40, NID_id_alg_des40 );
        OID_TO_NID.put( OBJ_id_alg_noSignature, NID_id_alg_noSignature );
        OID_TO_NID.put( OBJ_id_alg_dh_sig_hmac_sha1, NID_id_alg_dh_sig_hmac_sha1 );
        OID_TO_NID.put( OBJ_id_alg_dh_pop, NID_id_alg_dh_pop );
        OID_TO_NID.put( OBJ_id_cmc_statusInfo, NID_id_cmc_statusInfo );
        OID_TO_NID.put( OBJ_id_cmc_identification, NID_id_cmc_identification );
        OID_TO_NID.put( OBJ_id_cmc_identityProof, NID_id_cmc_identityProof );
        OID_TO_NID.put( OBJ_id_cmc_dataReturn, NID_id_cmc_dataReturn );
        OID_TO_NID.put( OBJ_id_cmc_transactionId, NID_id_cmc_transactionId );
        OID_TO_NID.put( OBJ_id_cmc_senderNonce, NID_id_cmc_senderNonce );
        OID_TO_NID.put( OBJ_id_cmc_recipientNonce, NID_id_cmc_recipientNonce );
        OID_TO_NID.put( OBJ_id_cmc_addExtensions, NID_id_cmc_addExtensions );
        OID_TO_NID.put( OBJ_id_cmc_encryptedPOP, NID_id_cmc_encryptedPOP );
        OID_TO_NID.put( OBJ_id_cmc_decryptedPOP, NID_id_cmc_decryptedPOP );
        OID_TO_NID.put( OBJ_id_cmc_lraPOPWitness, NID_id_cmc_lraPOPWitness );
        OID_TO_NID.put( OBJ_id_cmc_getCert, NID_id_cmc_getCert );
        OID_TO_NID.put( OBJ_id_cmc_getCRL, NID_id_cmc_getCRL );
        OID_TO_NID.put( OBJ_id_cmc_revokeRequest, NID_id_cmc_revokeRequest );
        OID_TO_NID.put( OBJ_id_cmc_regInfo, NID_id_cmc_regInfo );
        OID_TO_NID.put( OBJ_id_cmc_responseInfo, NID_id_cmc_responseInfo );
        OID_TO_NID.put( OBJ_id_cmc_queryPending, NID_id_cmc_queryPending );
        OID_TO_NID.put( OBJ_id_cmc_popLinkRandom, NID_id_cmc_popLinkRandom );
        OID_TO_NID.put( OBJ_id_cmc_popLinkWitness, NID_id_cmc_popLinkWitness );
        OID_TO_NID.put( OBJ_id_cmc_confirmCertAcceptance, NID_id_cmc_confirmCertAcceptance );
        OID_TO_NID.put( OBJ_id_on_personalData, NID_id_on_personalData );
        OID_TO_NID.put( OBJ_id_on_permanentIdentifier, NID_id_on_permanentIdentifier );
        OID_TO_NID.put( OBJ_id_pda_dateOfBirth, NID_id_pda_dateOfBirth );
        OID_TO_NID.put( OBJ_id_pda_placeOfBirth, NID_id_pda_placeOfBirth );
        OID_TO_NID.put( OBJ_id_pda_gender, NID_id_pda_gender );
        OID_TO_NID.put( OBJ_id_pda_countryOfCitizenship, NID_id_pda_countryOfCitizenship );
        OID_TO_NID.put( OBJ_id_pda_countryOfResidence, NID_id_pda_countryOfResidence );
        OID_TO_NID.put( OBJ_id_aca_authenticationInfo, NID_id_aca_authenticationInfo );
        OID_TO_NID.put( OBJ_id_aca_accessIdentity, NID_id_aca_accessIdentity );
        OID_TO_NID.put( OBJ_id_aca_chargingIdentity, NID_id_aca_chargingIdentity );
        OID_TO_NID.put( OBJ_id_aca_group, NID_id_aca_group );
        OID_TO_NID.put( OBJ_id_aca_role, NID_id_aca_role );
        OID_TO_NID.put( OBJ_id_aca_encAttrs, NID_id_aca_encAttrs );
        OID_TO_NID.put( OBJ_id_qcs_pkixQCSyntax_v1, NID_id_qcs_pkixQCSyntax_v1 );
        OID_TO_NID.put( OBJ_id_cct_crs, NID_id_cct_crs );
        OID_TO_NID.put( OBJ_id_cct_PKIData, NID_id_cct_PKIData );
        OID_TO_NID.put( OBJ_id_cct_PKIResponse, NID_id_cct_PKIResponse );
        OID_TO_NID.put( OBJ_id_ppl_anyLanguage, NID_id_ppl_anyLanguage );
        OID_TO_NID.put( OBJ_id_ppl_inheritAll, NID_id_ppl_inheritAll );
        OID_TO_NID.put( OBJ_Independent, NID_Independent );
        OID_TO_NID.put( OBJ_ad_OCSP, NID_ad_OCSP );
        OID_TO_NID.put( OBJ_ad_ca_issuers, NID_ad_ca_issuers );
        OID_TO_NID.put( OBJ_ad_timeStamping, NID_ad_timeStamping );
        OID_TO_NID.put( OBJ_ad_dvcs, NID_ad_dvcs );
        OID_TO_NID.put( OBJ_caRepository, NID_caRepository );
        OID_TO_NID.put( OBJ_id_pkix_OCSP_basic, NID_id_pkix_OCSP_basic );
        OID_TO_NID.put( OBJ_id_pkix_OCSP_Nonce, NID_id_pkix_OCSP_Nonce );
        OID_TO_NID.put( OBJ_id_pkix_OCSP_CrlID, NID_id_pkix_OCSP_CrlID );
        OID_TO_NID.put( OBJ_id_pkix_OCSP_acceptableResponses, NID_id_pkix_OCSP_acceptableResponses );
        OID_TO_NID.put( OBJ_id_pkix_OCSP_noCheck, NID_id_pkix_OCSP_noCheck );
        OID_TO_NID.put( OBJ_id_pkix_OCSP_archiveCutoff, NID_id_pkix_OCSP_archiveCutoff );
        OID_TO_NID.put( OBJ_id_pkix_OCSP_serviceLocator, NID_id_pkix_OCSP_serviceLocator );
        OID_TO_NID.put( OBJ_id_pkix_OCSP_extendedStatus, NID_id_pkix_OCSP_extendedStatus );
        OID_TO_NID.put( OBJ_id_pkix_OCSP_valid, NID_id_pkix_OCSP_valid );
        OID_TO_NID.put( OBJ_id_pkix_OCSP_path, NID_id_pkix_OCSP_path );
        OID_TO_NID.put( OBJ_id_pkix_OCSP_trustRoot, NID_id_pkix_OCSP_trustRoot );
        OID_TO_NID.put( OBJ_algorithm, NID_algorithm );
        OID_TO_NID.put( OBJ_md5WithRSA, NID_md5WithRSA );
        OID_TO_NID.put( OBJ_des_ecb, NID_des_ecb );
        OID_TO_NID.put( OBJ_des_cbc, NID_des_cbc );
        OID_TO_NID.put( OBJ_des_ofb64, NID_des_ofb64 );
        OID_TO_NID.put( OBJ_des_cfb64, NID_des_cfb64 );
        OID_TO_NID.put( OBJ_rsaSignature, NID_rsaSignature );
        OID_TO_NID.put( OBJ_dsa_2, NID_dsa_2 );
        OID_TO_NID.put( OBJ_dsaWithSHA, NID_dsaWithSHA );
        OID_TO_NID.put( OBJ_shaWithRSAEncryption, NID_shaWithRSAEncryption );
        OID_TO_NID.put( OBJ_des_ede_ecb, NID_des_ede_ecb );
        OID_TO_NID.put( OBJ_sha, NID_sha );
        OID_TO_NID.put( OBJ_sha1, NID_sha1 );
        OID_TO_NID.put( OBJ_dsaWithSHA1_2, NID_dsaWithSHA1_2 );
        OID_TO_NID.put( OBJ_sha1WithRSA, NID_sha1WithRSA );
        OID_TO_NID.put( OBJ_ripemd160, NID_ripemd160 );
        OID_TO_NID.put( OBJ_ripemd160WithRSA, NID_ripemd160WithRSA );
        OID_TO_NID.put( OBJ_sxnet, NID_sxnet );
        OID_TO_NID.put( OBJ_X500, NID_X500 );
        OID_TO_NID.put( OBJ_X509, NID_X509 );
        OID_TO_NID.put( OBJ_commonName, NID_commonName );
        OID_TO_NID.put( OBJ_surname, NID_surname );
        OID_TO_NID.put( OBJ_serialNumber, NID_serialNumber );
        OID_TO_NID.put( OBJ_countryName, NID_countryName );
        OID_TO_NID.put( OBJ_localityName, NID_localityName );
        OID_TO_NID.put( OBJ_stateOrProvinceName, NID_stateOrProvinceName );
        OID_TO_NID.put( OBJ_streetAddress, NID_streetAddress );
        OID_TO_NID.put( OBJ_organizationName, NID_organizationName );
        OID_TO_NID.put( OBJ_organizationalUnitName, NID_organizationalUnitName );
        OID_TO_NID.put( OBJ_title, NID_title );
        OID_TO_NID.put( OBJ_description, NID_description );
        OID_TO_NID.put( OBJ_searchGuide, NID_searchGuide );
        OID_TO_NID.put( OBJ_businessCategory, NID_businessCategory );
        OID_TO_NID.put( OBJ_postalAddress, NID_postalAddress );
        OID_TO_NID.put( OBJ_postalCode, NID_postalCode );
        OID_TO_NID.put( OBJ_postOfficeBox, NID_postOfficeBox );
        OID_TO_NID.put( OBJ_physicalDeliveryOfficeName, NID_physicalDeliveryOfficeName );
        OID_TO_NID.put( OBJ_telephoneNumber, NID_telephoneNumber );
        OID_TO_NID.put( OBJ_telexNumber, NID_telexNumber );
        OID_TO_NID.put( OBJ_teletexTerminalIdentifier, NID_teletexTerminalIdentifier );
        OID_TO_NID.put( OBJ_facsimileTelephoneNumber, NID_facsimileTelephoneNumber );
        OID_TO_NID.put( OBJ_x121Address, NID_x121Address );
        OID_TO_NID.put( OBJ_internationaliSDNNumber, NID_internationaliSDNNumber );
        OID_TO_NID.put( OBJ_registeredAddress, NID_registeredAddress );
        OID_TO_NID.put( OBJ_destinationIndicator, NID_destinationIndicator );
        OID_TO_NID.put( OBJ_preferredDeliveryMethod, NID_preferredDeliveryMethod );
        OID_TO_NID.put( OBJ_presentationAddress, NID_presentationAddress );
        OID_TO_NID.put( OBJ_supportedApplicationContext, NID_supportedApplicationContext );
        OID_TO_NID.put( OBJ_member, NID_member );
        OID_TO_NID.put( OBJ_owner, NID_owner );
        OID_TO_NID.put( OBJ_roleOccupant, NID_roleOccupant );
        OID_TO_NID.put( OBJ_seeAlso, NID_seeAlso );
        OID_TO_NID.put( OBJ_userPassword, NID_userPassword );
        OID_TO_NID.put( OBJ_userCertificate, NID_userCertificate );
        OID_TO_NID.put( OBJ_cACertificate, NID_cACertificate );
        OID_TO_NID.put( OBJ_authorityRevocationList, NID_authorityRevocationList );
        OID_TO_NID.put( OBJ_certificateRevocationList, NID_certificateRevocationList );
        OID_TO_NID.put( OBJ_crossCertificatePair, NID_crossCertificatePair );
        OID_TO_NID.put( OBJ_name, NID_name );
        OID_TO_NID.put( OBJ_givenName, NID_givenName );
        OID_TO_NID.put( OBJ_initials, NID_initials );
        OID_TO_NID.put( OBJ_generationQualifier, NID_generationQualifier );
        OID_TO_NID.put( OBJ_x500UniqueIdentifier, NID_x500UniqueIdentifier );
        OID_TO_NID.put( OBJ_dnQualifier, NID_dnQualifier );
        OID_TO_NID.put( OBJ_enhancedSearchGuide, NID_enhancedSearchGuide );
        OID_TO_NID.put( OBJ_protocolInformation, NID_protocolInformation );
        OID_TO_NID.put( OBJ_distinguishedName, NID_distinguishedName );
        OID_TO_NID.put( OBJ_uniqueMember, NID_uniqueMember );
        OID_TO_NID.put( OBJ_houseIdentifier, NID_houseIdentifier );
        OID_TO_NID.put( OBJ_supportedAlgorithms, NID_supportedAlgorithms );
        OID_TO_NID.put( OBJ_deltaRevocationList, NID_deltaRevocationList );
        OID_TO_NID.put( OBJ_dmdName, NID_dmdName );
        OID_TO_NID.put( OBJ_pseudonym, NID_pseudonym );
        OID_TO_NID.put( OBJ_role, NID_role );
        OID_TO_NID.put( OBJ_X500algorithms, NID_X500algorithms );
        OID_TO_NID.put( OBJ_rsa, NID_rsa );
        OID_TO_NID.put( OBJ_mdc2WithRSA, NID_mdc2WithRSA );
        OID_TO_NID.put( OBJ_mdc2, NID_mdc2 );
        OID_TO_NID.put( OBJ_id_ce, NID_id_ce );
        OID_TO_NID.put( OBJ_subject_directory_attributes, NID_subject_directory_attributes );
        OID_TO_NID.put( OBJ_subject_key_identifier, NID_subject_key_identifier );
        OID_TO_NID.put( OBJ_key_usage, NID_key_usage );
        OID_TO_NID.put( OBJ_private_key_usage_period, NID_private_key_usage_period );
        OID_TO_NID.put( OBJ_subject_alt_name, NID_subject_alt_name );
        OID_TO_NID.put( OBJ_issuer_alt_name, NID_issuer_alt_name );
        OID_TO_NID.put( OBJ_basic_constraints, NID_basic_constraints );
        OID_TO_NID.put( OBJ_crl_number, NID_crl_number );
        OID_TO_NID.put( OBJ_crl_reason, NID_crl_reason );
        OID_TO_NID.put( OBJ_invalidity_date, NID_invalidity_date );
        OID_TO_NID.put( OBJ_delta_crl, NID_delta_crl );
        OID_TO_NID.put( OBJ_issuing_distribution_point, NID_issuing_distribution_point );
        OID_TO_NID.put( OBJ_certificate_issuer, NID_certificate_issuer );
        OID_TO_NID.put( OBJ_name_constraints, NID_name_constraints );
        OID_TO_NID.put( OBJ_crl_distribution_points, NID_crl_distribution_points );
        OID_TO_NID.put( OBJ_certificate_policies, NID_certificate_policies );
        OID_TO_NID.put( OBJ_any_policy, NID_any_policy );
        OID_TO_NID.put( OBJ_policy_mappings, NID_policy_mappings );
        OID_TO_NID.put( OBJ_authority_key_identifier, NID_authority_key_identifier );
        OID_TO_NID.put( OBJ_policy_constraints, NID_policy_constraints );
        OID_TO_NID.put( OBJ_ext_key_usage, NID_ext_key_usage );
        OID_TO_NID.put( OBJ_freshest_crl, NID_freshest_crl );
        OID_TO_NID.put( OBJ_inhibit_any_policy, NID_inhibit_any_policy );
        OID_TO_NID.put( OBJ_target_information, NID_target_information );
        OID_TO_NID.put( OBJ_no_rev_avail, NID_no_rev_avail );
        OID_TO_NID.put( OBJ_anyExtendedKeyUsage, NID_anyExtendedKeyUsage );
        OID_TO_NID.put( OBJ_netscape, NID_netscape );
        OID_TO_NID.put( OBJ_netscape_cert_extension, NID_netscape_cert_extension );
        OID_TO_NID.put( OBJ_netscape_data_type, NID_netscape_data_type );
        OID_TO_NID.put( OBJ_netscape_cert_type, NID_netscape_cert_type );
        OID_TO_NID.put( OBJ_netscape_base_url, NID_netscape_base_url );
        OID_TO_NID.put( OBJ_netscape_revocation_url, NID_netscape_revocation_url );
        OID_TO_NID.put( OBJ_netscape_ca_revocation_url, NID_netscape_ca_revocation_url );
        OID_TO_NID.put( OBJ_netscape_renewal_url, NID_netscape_renewal_url );
        OID_TO_NID.put( OBJ_netscape_ca_policy_url, NID_netscape_ca_policy_url );
        OID_TO_NID.put( OBJ_netscape_ssl_server_name, NID_netscape_ssl_server_name );
        OID_TO_NID.put( OBJ_netscape_comment, NID_netscape_comment );
        OID_TO_NID.put( OBJ_netscape_cert_sequence, NID_netscape_cert_sequence );
        OID_TO_NID.put( OBJ_ns_sgc, NID_ns_sgc );
        OID_TO_NID.put( OBJ_org, NID_org );
        OID_TO_NID.put( OBJ_dod, NID_dod );
        OID_TO_NID.put( OBJ_iana, NID_iana );
        OID_TO_NID.put( OBJ_Directory, NID_Directory );
        OID_TO_NID.put( OBJ_Management, NID_Management );
        OID_TO_NID.put( OBJ_Experimental, NID_Experimental );
        OID_TO_NID.put( OBJ_Private, NID_Private );
        OID_TO_NID.put( OBJ_Security, NID_Security );
        OID_TO_NID.put( OBJ_SNMPv2, NID_SNMPv2 );
        OID_TO_NID.put( OBJ_Mail, NID_Mail );
        OID_TO_NID.put( OBJ_Enterprises, NID_Enterprises );
        OID_TO_NID.put( OBJ_dcObject, NID_dcObject );
        OID_TO_NID.put( OBJ_mime_mhs, NID_mime_mhs );
        OID_TO_NID.put( OBJ_mime_mhs_headings, NID_mime_mhs_headings );
        OID_TO_NID.put( OBJ_mime_mhs_bodies, NID_mime_mhs_bodies );
        OID_TO_NID.put( OBJ_id_hex_partial_message, NID_id_hex_partial_message );
        OID_TO_NID.put( OBJ_id_hex_multipart_message, NID_id_hex_multipart_message );
        OID_TO_NID.put( OBJ_rle_compression, NID_rle_compression );
        OID_TO_NID.put( OBJ_zlib_compression, NID_zlib_compression );
        OID_TO_NID.put( OBJ_aes_128_ecb, NID_aes_128_ecb );
        OID_TO_NID.put( OBJ_aes_128_cbc, NID_aes_128_cbc );
        OID_TO_NID.put( OBJ_aes_128_ofb128, NID_aes_128_ofb128 );
        OID_TO_NID.put( OBJ_aes_128_cfb128, NID_aes_128_cfb128 );
        OID_TO_NID.put( OBJ_id_aes128_wrap, NID_id_aes128_wrap );
        OID_TO_NID.put( OBJ_aes_128_gcm, NID_aes_128_gcm );
        OID_TO_NID.put( OBJ_aes_128_ccm, NID_aes_128_ccm );
        OID_TO_NID.put( OBJ_id_aes128_wrap_pad, NID_id_aes128_wrap_pad );
        OID_TO_NID.put( OBJ_aes_192_ecb, NID_aes_192_ecb );
        OID_TO_NID.put( OBJ_aes_192_cbc, NID_aes_192_cbc );
        OID_TO_NID.put( OBJ_aes_192_ofb128, NID_aes_192_ofb128 );
        OID_TO_NID.put( OBJ_aes_192_cfb128, NID_aes_192_cfb128 );
        OID_TO_NID.put( OBJ_id_aes192_wrap, NID_id_aes192_wrap );
        OID_TO_NID.put( OBJ_aes_192_gcm, NID_aes_192_gcm );
        OID_TO_NID.put( OBJ_aes_192_ccm, NID_aes_192_ccm );
        OID_TO_NID.put( OBJ_id_aes192_wrap_pad, NID_id_aes192_wrap_pad );
        OID_TO_NID.put( OBJ_aes_256_ecb, NID_aes_256_ecb );
        OID_TO_NID.put( OBJ_aes_256_cbc, NID_aes_256_cbc );
        OID_TO_NID.put( OBJ_aes_256_ofb128, NID_aes_256_ofb128 );
        OID_TO_NID.put( OBJ_aes_256_cfb128, NID_aes_256_cfb128 );
        OID_TO_NID.put( OBJ_id_aes256_wrap, NID_id_aes256_wrap );
        OID_TO_NID.put( OBJ_aes_256_gcm, NID_aes_256_gcm );
        OID_TO_NID.put( OBJ_aes_256_ccm, NID_aes_256_ccm );
        OID_TO_NID.put( OBJ_id_aes256_wrap_pad, NID_id_aes256_wrap_pad );
        OID_TO_NID.put( OBJ_sha256, NID_sha256 );
        OID_TO_NID.put( OBJ_sha384, NID_sha384 );
        OID_TO_NID.put( OBJ_sha512, NID_sha512 );
        OID_TO_NID.put( OBJ_sha224, NID_sha224 );
        OID_TO_NID.put( OBJ_dsa_with_SHA224, NID_dsa_with_SHA224 );
        OID_TO_NID.put( OBJ_dsa_with_SHA256, NID_dsa_with_SHA256 );
        OID_TO_NID.put( OBJ_hold_instruction_code, NID_hold_instruction_code );
        OID_TO_NID.put( OBJ_hold_instruction_none, NID_hold_instruction_none );
        OID_TO_NID.put( OBJ_hold_instruction_call_issuer, NID_hold_instruction_call_issuer );
        OID_TO_NID.put( OBJ_hold_instruction_reject, NID_hold_instruction_reject );
        OID_TO_NID.put( OBJ_data, NID_data );
        OID_TO_NID.put( OBJ_pss, NID_pss );
        OID_TO_NID.put( OBJ_ucl, NID_ucl );
        OID_TO_NID.put( OBJ_pilot, NID_pilot );
        OID_TO_NID.put( OBJ_pilotAttributeType, NID_pilotAttributeType );
        OID_TO_NID.put( OBJ_pilotAttributeSyntax, NID_pilotAttributeSyntax );
        OID_TO_NID.put( OBJ_pilotObjectClass, NID_pilotObjectClass );
        OID_TO_NID.put( OBJ_pilotGroups, NID_pilotGroups );
        OID_TO_NID.put( OBJ_iA5StringSyntax, NID_iA5StringSyntax );
        OID_TO_NID.put( OBJ_caseIgnoreIA5StringSyntax, NID_caseIgnoreIA5StringSyntax );
        OID_TO_NID.put( OBJ_pilotObject, NID_pilotObject );
        OID_TO_NID.put( OBJ_pilotPerson, NID_pilotPerson );
        OID_TO_NID.put( OBJ_account, NID_account );
        OID_TO_NID.put( OBJ_document, NID_document );
        OID_TO_NID.put( OBJ_room, NID_room );
        OID_TO_NID.put( OBJ_documentSeries, NID_documentSeries );
        OID_TO_NID.put( OBJ_Domain, NID_Domain );
        OID_TO_NID.put( OBJ_rFC822localPart, NID_rFC822localPart );
        OID_TO_NID.put( OBJ_dNSDomain, NID_dNSDomain );
        OID_TO_NID.put( OBJ_domainRelatedObject, NID_domainRelatedObject );
        OID_TO_NID.put( OBJ_friendlyCountry, NID_friendlyCountry );
        OID_TO_NID.put( OBJ_simpleSecurityObject, NID_simpleSecurityObject );
        OID_TO_NID.put( OBJ_pilotOrganization, NID_pilotOrganization );
        OID_TO_NID.put( OBJ_pilotDSA, NID_pilotDSA );
        OID_TO_NID.put( OBJ_qualityLabelledData, NID_qualityLabelledData );
        OID_TO_NID.put( OBJ_userId, NID_userId );
        OID_TO_NID.put( OBJ_textEncodedORAddress, NID_textEncodedORAddress );
        OID_TO_NID.put( OBJ_rfc822Mailbox, NID_rfc822Mailbox );
        OID_TO_NID.put( OBJ_info, NID_info );
        OID_TO_NID.put( OBJ_favouriteDrink, NID_favouriteDrink );
        OID_TO_NID.put( OBJ_roomNumber, NID_roomNumber );
        OID_TO_NID.put( OBJ_photo, NID_photo );
        OID_TO_NID.put( OBJ_userClass, NID_userClass );
        OID_TO_NID.put( OBJ_host, NID_host );
        OID_TO_NID.put( OBJ_manager, NID_manager );
        OID_TO_NID.put( OBJ_documentIdentifier, NID_documentIdentifier );
        OID_TO_NID.put( OBJ_documentTitle, NID_documentTitle );
        OID_TO_NID.put( OBJ_documentVersion, NID_documentVersion );
        OID_TO_NID.put( OBJ_documentAuthor, NID_documentAuthor );
        OID_TO_NID.put( OBJ_documentLocation, NID_documentLocation );
        OID_TO_NID.put( OBJ_homeTelephoneNumber, NID_homeTelephoneNumber );
        OID_TO_NID.put( OBJ_secretary, NID_secretary );
        OID_TO_NID.put( OBJ_otherMailbox, NID_otherMailbox );
        OID_TO_NID.put( OBJ_lastModifiedTime, NID_lastModifiedTime );
        OID_TO_NID.put( OBJ_lastModifiedBy, NID_lastModifiedBy );
        OID_TO_NID.put( OBJ_domainComponent, NID_domainComponent );
        OID_TO_NID.put( OBJ_aRecord, NID_aRecord );
        OID_TO_NID.put( OBJ_pilotAttributeType27, NID_pilotAttributeType27 );
        OID_TO_NID.put( OBJ_mXRecord, NID_mXRecord );
        OID_TO_NID.put( OBJ_nSRecord, NID_nSRecord );
        OID_TO_NID.put( OBJ_sOARecord, NID_sOARecord );
        OID_TO_NID.put( OBJ_cNAMERecord, NID_cNAMERecord );
        OID_TO_NID.put( OBJ_associatedDomain, NID_associatedDomain );
        OID_TO_NID.put( OBJ_associatedName, NID_associatedName );
        OID_TO_NID.put( OBJ_homePostalAddress, NID_homePostalAddress );
        OID_TO_NID.put( OBJ_personalTitle, NID_personalTitle );
        OID_TO_NID.put( OBJ_mobileTelephoneNumber, NID_mobileTelephoneNumber );
        OID_TO_NID.put( OBJ_pagerTelephoneNumber, NID_pagerTelephoneNumber );
        OID_TO_NID.put( OBJ_friendlyCountryName, NID_friendlyCountryName );
        OID_TO_NID.put( OBJ_organizationalStatus, NID_organizationalStatus );
        OID_TO_NID.put( OBJ_janetMailbox, NID_janetMailbox );
        OID_TO_NID.put( OBJ_mailPreferenceOption, NID_mailPreferenceOption );
        OID_TO_NID.put( OBJ_buildingName, NID_buildingName );
        OID_TO_NID.put( OBJ_dSAQuality, NID_dSAQuality );
        OID_TO_NID.put( OBJ_singleLevelQuality, NID_singleLevelQuality );
        OID_TO_NID.put( OBJ_subtreeMinimumQuality, NID_subtreeMinimumQuality );
        OID_TO_NID.put( OBJ_subtreeMaximumQuality, NID_subtreeMaximumQuality );
        OID_TO_NID.put( OBJ_personalSignature, NID_personalSignature );
        OID_TO_NID.put( OBJ_dITRedirect, NID_dITRedirect );
        OID_TO_NID.put( OBJ_audio, NID_audio );
        OID_TO_NID.put( OBJ_documentPublisher, NID_documentPublisher );
        OID_TO_NID.put( OBJ_id_set, NID_id_set );
        OID_TO_NID.put( OBJ_set_ctype, NID_set_ctype );
        OID_TO_NID.put( OBJ_set_msgExt, NID_set_msgExt );
        OID_TO_NID.put( OBJ_set_attr, NID_set_attr );
        OID_TO_NID.put( OBJ_set_policy, NID_set_policy );
        OID_TO_NID.put( OBJ_set_certExt, NID_set_certExt );
        OID_TO_NID.put( OBJ_set_brand, NID_set_brand );
        OID_TO_NID.put( OBJ_setct_PANData, NID_setct_PANData );
        OID_TO_NID.put( OBJ_setct_PANToken, NID_setct_PANToken );
        OID_TO_NID.put( OBJ_setct_PANOnly, NID_setct_PANOnly );
        OID_TO_NID.put( OBJ_setct_OIData, NID_setct_OIData );
        OID_TO_NID.put( OBJ_setct_PI, NID_setct_PI );
        OID_TO_NID.put( OBJ_setct_PIData, NID_setct_PIData );
        OID_TO_NID.put( OBJ_setct_PIDataUnsigned, NID_setct_PIDataUnsigned );
        OID_TO_NID.put( OBJ_setct_HODInput, NID_setct_HODInput );
        OID_TO_NID.put( OBJ_setct_AuthResBaggage, NID_setct_AuthResBaggage );
        OID_TO_NID.put( OBJ_setct_AuthRevReqBaggage, NID_setct_AuthRevReqBaggage );
        OID_TO_NID.put( OBJ_setct_AuthRevResBaggage, NID_setct_AuthRevResBaggage );
        OID_TO_NID.put( OBJ_setct_CapTokenSeq, NID_setct_CapTokenSeq );
        OID_TO_NID.put( OBJ_setct_PInitResData, NID_setct_PInitResData );
        OID_TO_NID.put( OBJ_setct_PI_TBS, NID_setct_PI_TBS );
        OID_TO_NID.put( OBJ_setct_PResData, NID_setct_PResData );
        OID_TO_NID.put( OBJ_setct_AuthReqTBS, NID_setct_AuthReqTBS );
        OID_TO_NID.put( OBJ_setct_AuthResTBS, NID_setct_AuthResTBS );
        OID_TO_NID.put( OBJ_setct_AuthResTBSX, NID_setct_AuthResTBSX );
        OID_TO_NID.put( OBJ_setct_AuthTokenTBS, NID_setct_AuthTokenTBS );
        OID_TO_NID.put( OBJ_setct_CapTokenData, NID_setct_CapTokenData );
        OID_TO_NID.put( OBJ_setct_CapTokenTBS, NID_setct_CapTokenTBS );
        OID_TO_NID.put( OBJ_setct_AcqCardCodeMsg, NID_setct_AcqCardCodeMsg );
        OID_TO_NID.put( OBJ_setct_AuthRevReqTBS, NID_setct_AuthRevReqTBS );
        OID_TO_NID.put( OBJ_setct_AuthRevResData, NID_setct_AuthRevResData );
        OID_TO_NID.put( OBJ_setct_AuthRevResTBS, NID_setct_AuthRevResTBS );
        OID_TO_NID.put( OBJ_setct_CapReqTBS, NID_setct_CapReqTBS );
        OID_TO_NID.put( OBJ_setct_CapReqTBSX, NID_setct_CapReqTBSX );
        OID_TO_NID.put( OBJ_setct_CapResData, NID_setct_CapResData );
        OID_TO_NID.put( OBJ_setct_CapRevReqTBS, NID_setct_CapRevReqTBS );
        OID_TO_NID.put( OBJ_setct_CapRevReqTBSX, NID_setct_CapRevReqTBSX );
        OID_TO_NID.put( OBJ_setct_CapRevResData, NID_setct_CapRevResData );
        OID_TO_NID.put( OBJ_setct_CredReqTBS, NID_setct_CredReqTBS );
        OID_TO_NID.put( OBJ_setct_CredReqTBSX, NID_setct_CredReqTBSX );
        OID_TO_NID.put( OBJ_setct_CredResData, NID_setct_CredResData );
        OID_TO_NID.put( OBJ_setct_CredRevReqTBS, NID_setct_CredRevReqTBS );
        OID_TO_NID.put( OBJ_setct_CredRevReqTBSX, NID_setct_CredRevReqTBSX );
        OID_TO_NID.put( OBJ_setct_CredRevResData, NID_setct_CredRevResData );
        OID_TO_NID.put( OBJ_setct_PCertReqData, NID_setct_PCertReqData );
        OID_TO_NID.put( OBJ_setct_PCertResTBS, NID_setct_PCertResTBS );
        OID_TO_NID.put( OBJ_setct_BatchAdminReqData, NID_setct_BatchAdminReqData );
        OID_TO_NID.put( OBJ_setct_BatchAdminResData, NID_setct_BatchAdminResData );
        OID_TO_NID.put( OBJ_setct_CardCInitResTBS, NID_setct_CardCInitResTBS );
        OID_TO_NID.put( OBJ_setct_MeAqCInitResTBS, NID_setct_MeAqCInitResTBS );
        OID_TO_NID.put( OBJ_setct_RegFormResTBS, NID_setct_RegFormResTBS );
        OID_TO_NID.put( OBJ_setct_CertReqData, NID_setct_CertReqData );
        OID_TO_NID.put( OBJ_setct_CertReqTBS, NID_setct_CertReqTBS );
        OID_TO_NID.put( OBJ_setct_CertResData, NID_setct_CertResData );
        OID_TO_NID.put( OBJ_setct_CertInqReqTBS, NID_setct_CertInqReqTBS );
        OID_TO_NID.put( OBJ_setct_ErrorTBS, NID_setct_ErrorTBS );
        OID_TO_NID.put( OBJ_setct_PIDualSignedTBE, NID_setct_PIDualSignedTBE );
        OID_TO_NID.put( OBJ_setct_PIUnsignedTBE, NID_setct_PIUnsignedTBE );
        OID_TO_NID.put( OBJ_setct_AuthReqTBE, NID_setct_AuthReqTBE );
        OID_TO_NID.put( OBJ_setct_AuthResTBE, NID_setct_AuthResTBE );
        OID_TO_NID.put( OBJ_setct_AuthResTBEX, NID_setct_AuthResTBEX );
        OID_TO_NID.put( OBJ_setct_AuthTokenTBE, NID_setct_AuthTokenTBE );
        OID_TO_NID.put( OBJ_setct_CapTokenTBE, NID_setct_CapTokenTBE );
        OID_TO_NID.put( OBJ_setct_CapTokenTBEX, NID_setct_CapTokenTBEX );
        OID_TO_NID.put( OBJ_setct_AcqCardCodeMsgTBE, NID_setct_AcqCardCodeMsgTBE );
        OID_TO_NID.put( OBJ_setct_AuthRevReqTBE, NID_setct_AuthRevReqTBE );
        OID_TO_NID.put( OBJ_setct_AuthRevResTBE, NID_setct_AuthRevResTBE );
        OID_TO_NID.put( OBJ_setct_AuthRevResTBEB, NID_setct_AuthRevResTBEB );
        OID_TO_NID.put( OBJ_setct_CapReqTBE, NID_setct_CapReqTBE );
        OID_TO_NID.put( OBJ_setct_CapReqTBEX, NID_setct_CapReqTBEX );
        OID_TO_NID.put( OBJ_setct_CapResTBE, NID_setct_CapResTBE );
        OID_TO_NID.put( OBJ_setct_CapRevReqTBE, NID_setct_CapRevReqTBE );
        OID_TO_NID.put( OBJ_setct_CapRevReqTBEX, NID_setct_CapRevReqTBEX );
        OID_TO_NID.put( OBJ_setct_CapRevResTBE, NID_setct_CapRevResTBE );
        OID_TO_NID.put( OBJ_setct_CredReqTBE, NID_setct_CredReqTBE );
        OID_TO_NID.put( OBJ_setct_CredReqTBEX, NID_setct_CredReqTBEX );
        OID_TO_NID.put( OBJ_setct_CredResTBE, NID_setct_CredResTBE );
        OID_TO_NID.put( OBJ_setct_CredRevReqTBE, NID_setct_CredRevReqTBE );
        OID_TO_NID.put( OBJ_setct_CredRevReqTBEX, NID_setct_CredRevReqTBEX );
        OID_TO_NID.put( OBJ_setct_CredRevResTBE, NID_setct_CredRevResTBE );
        OID_TO_NID.put( OBJ_setct_BatchAdminReqTBE, NID_setct_BatchAdminReqTBE );
        OID_TO_NID.put( OBJ_setct_BatchAdminResTBE, NID_setct_BatchAdminResTBE );
        OID_TO_NID.put( OBJ_setct_RegFormReqTBE, NID_setct_RegFormReqTBE );
        OID_TO_NID.put( OBJ_setct_CertReqTBE, NID_setct_CertReqTBE );
        OID_TO_NID.put( OBJ_setct_CertReqTBEX, NID_setct_CertReqTBEX );
        OID_TO_NID.put( OBJ_setct_CertResTBE, NID_setct_CertResTBE );
        OID_TO_NID.put( OBJ_setct_CRLNotificationTBS, NID_setct_CRLNotificationTBS );
        OID_TO_NID.put( OBJ_setct_CRLNotificationResTBS, NID_setct_CRLNotificationResTBS );
        OID_TO_NID.put( OBJ_setct_BCIDistributionTBS, NID_setct_BCIDistributionTBS );
        OID_TO_NID.put( OBJ_setext_genCrypt, NID_setext_genCrypt );
        OID_TO_NID.put( OBJ_setext_miAuth, NID_setext_miAuth );
        OID_TO_NID.put( OBJ_setext_pinSecure, NID_setext_pinSecure );
        OID_TO_NID.put( OBJ_setext_pinAny, NID_setext_pinAny );
        OID_TO_NID.put( OBJ_setext_track2, NID_setext_track2 );
        OID_TO_NID.put( OBJ_setext_cv, NID_setext_cv );
        OID_TO_NID.put( OBJ_set_policy_root, NID_set_policy_root );
        OID_TO_NID.put( OBJ_setCext_hashedRoot, NID_setCext_hashedRoot );
        OID_TO_NID.put( OBJ_setCext_certType, NID_setCext_certType );
        OID_TO_NID.put( OBJ_setCext_merchData, NID_setCext_merchData );
        OID_TO_NID.put( OBJ_setCext_cCertRequired, NID_setCext_cCertRequired );
        OID_TO_NID.put( OBJ_setCext_tunneling, NID_setCext_tunneling );
        OID_TO_NID.put( OBJ_setCext_setExt, NID_setCext_setExt );
        OID_TO_NID.put( OBJ_setCext_setQualf, NID_setCext_setQualf );
        OID_TO_NID.put( OBJ_setCext_PGWYcapabilities, NID_setCext_PGWYcapabilities );
        OID_TO_NID.put( OBJ_setCext_TokenIdentifier, NID_setCext_TokenIdentifier );
        OID_TO_NID.put( OBJ_setCext_Track2Data, NID_setCext_Track2Data );
        OID_TO_NID.put( OBJ_setCext_TokenType, NID_setCext_TokenType );
        OID_TO_NID.put( OBJ_setCext_IssuerCapabilities, NID_setCext_IssuerCapabilities );
        OID_TO_NID.put( OBJ_setAttr_Cert, NID_setAttr_Cert );
        OID_TO_NID.put( OBJ_setAttr_PGWYcap, NID_setAttr_PGWYcap );
        OID_TO_NID.put( OBJ_setAttr_TokenType, NID_setAttr_TokenType );
        OID_TO_NID.put( OBJ_setAttr_IssCap, NID_setAttr_IssCap );
        OID_TO_NID.put( OBJ_set_rootKeyThumb, NID_set_rootKeyThumb );
        OID_TO_NID.put( OBJ_set_addPolicy, NID_set_addPolicy );
        OID_TO_NID.put( OBJ_setAttr_Token_EMV, NID_setAttr_Token_EMV );
        OID_TO_NID.put( OBJ_setAttr_Token_B0Prime, NID_setAttr_Token_B0Prime );
        OID_TO_NID.put( OBJ_setAttr_IssCap_CVM, NID_setAttr_IssCap_CVM );
        OID_TO_NID.put( OBJ_setAttr_IssCap_T2, NID_setAttr_IssCap_T2 );
        OID_TO_NID.put( OBJ_setAttr_IssCap_Sig, NID_setAttr_IssCap_Sig );
        OID_TO_NID.put( OBJ_setAttr_GenCryptgrm, NID_setAttr_GenCryptgrm );
        OID_TO_NID.put( OBJ_setAttr_T2Enc, NID_setAttr_T2Enc );
        OID_TO_NID.put( OBJ_setAttr_T2cleartxt, NID_setAttr_T2cleartxt );
        OID_TO_NID.put( OBJ_setAttr_TokICCsig, NID_setAttr_TokICCsig );
        OID_TO_NID.put( OBJ_setAttr_SecDevSig, NID_setAttr_SecDevSig );
        OID_TO_NID.put( OBJ_set_brand_IATA_ATA, NID_set_brand_IATA_ATA );
        OID_TO_NID.put( OBJ_set_brand_Diners, NID_set_brand_Diners );
        OID_TO_NID.put( OBJ_set_brand_AmericanExpress, NID_set_brand_AmericanExpress );
        OID_TO_NID.put( OBJ_set_brand_JCB, NID_set_brand_JCB );
        OID_TO_NID.put( OBJ_set_brand_Visa, NID_set_brand_Visa );
        OID_TO_NID.put( OBJ_set_brand_MasterCard, NID_set_brand_MasterCard );
        OID_TO_NID.put( OBJ_set_brand_Novus, NID_set_brand_Novus );
        OID_TO_NID.put( OBJ_des_cdmf, NID_des_cdmf );
        OID_TO_NID.put( OBJ_rsaOAEPEncryptionSET, NID_rsaOAEPEncryptionSET );
        OID_TO_NID.put( OBJ_whirlpool, NID_whirlpool );
        OID_TO_NID.put( OBJ_cryptopro, NID_cryptopro );
        OID_TO_NID.put( OBJ_cryptocom, NID_cryptocom );
        OID_TO_NID.put( OBJ_id_GostR3411_94_with_GostR3410_2001, NID_id_GostR3411_94_with_GostR3410_2001 );
        OID_TO_NID.put( OBJ_id_GostR3411_94_with_GostR3410_94, NID_id_GostR3411_94_with_GostR3410_94 );
        OID_TO_NID.put( OBJ_id_GostR3411_94, NID_id_GostR3411_94 );
        OID_TO_NID.put( OBJ_id_HMACGostR3411_94, NID_id_HMACGostR3411_94 );
        OID_TO_NID.put( OBJ_id_GostR3410_2001, NID_id_GostR3410_2001 );
        OID_TO_NID.put( OBJ_id_GostR3410_94, NID_id_GostR3410_94 );
        OID_TO_NID.put( OBJ_id_Gost28147_89, NID_id_Gost28147_89 );
        OID_TO_NID.put( OBJ_id_Gost28147_89_MAC, NID_id_Gost28147_89_MAC );
        OID_TO_NID.put( OBJ_id_GostR3411_94_prf, NID_id_GostR3411_94_prf );
        OID_TO_NID.put( OBJ_id_GostR3410_2001DH, NID_id_GostR3410_2001DH );
        OID_TO_NID.put( OBJ_id_GostR3410_94DH, NID_id_GostR3410_94DH );
        OID_TO_NID.put( OBJ_id_Gost28147_89_CryptoPro_KeyMeshing, NID_id_Gost28147_89_CryptoPro_KeyMeshing );
        OID_TO_NID.put( OBJ_id_Gost28147_89_None_KeyMeshing, NID_id_Gost28147_89_None_KeyMeshing );
        OID_TO_NID.put( OBJ_id_GostR3411_94_TestParamSet, NID_id_GostR3411_94_TestParamSet );
        OID_TO_NID.put( OBJ_id_GostR3411_94_CryptoProParamSet, NID_id_GostR3411_94_CryptoProParamSet );
        OID_TO_NID.put( OBJ_id_Gost28147_89_TestParamSet, NID_id_Gost28147_89_TestParamSet );
        OID_TO_NID.put( OBJ_id_Gost28147_89_CryptoPro_A_ParamSet, NID_id_Gost28147_89_CryptoPro_A_ParamSet );
        OID_TO_NID.put( OBJ_id_Gost28147_89_CryptoPro_B_ParamSet, NID_id_Gost28147_89_CryptoPro_B_ParamSet );
        OID_TO_NID.put( OBJ_id_Gost28147_89_CryptoPro_C_ParamSet, NID_id_Gost28147_89_CryptoPro_C_ParamSet );
        OID_TO_NID.put( OBJ_id_Gost28147_89_CryptoPro_D_ParamSet, NID_id_Gost28147_89_CryptoPro_D_ParamSet );
        OID_TO_NID.put( OBJ_id_Gost28147_89_CryptoPro_Oscar_1_1_ParamSet, NID_id_Gost28147_89_CryptoPro_Oscar_1_1_ParamSet );
        OID_TO_NID.put( OBJ_id_Gost28147_89_CryptoPro_Oscar_1_0_ParamSet, NID_id_Gost28147_89_CryptoPro_Oscar_1_0_ParamSet );
        OID_TO_NID.put( OBJ_id_Gost28147_89_CryptoPro_RIC_1_ParamSet, NID_id_Gost28147_89_CryptoPro_RIC_1_ParamSet );
        OID_TO_NID.put( OBJ_id_GostR3410_94_TestParamSet, NID_id_GostR3410_94_TestParamSet );
        OID_TO_NID.put( OBJ_id_GostR3410_94_CryptoPro_A_ParamSet, NID_id_GostR3410_94_CryptoPro_A_ParamSet );
        OID_TO_NID.put( OBJ_id_GostR3410_94_CryptoPro_B_ParamSet, NID_id_GostR3410_94_CryptoPro_B_ParamSet );
        OID_TO_NID.put( OBJ_id_GostR3410_94_CryptoPro_C_ParamSet, NID_id_GostR3410_94_CryptoPro_C_ParamSet );
        OID_TO_NID.put( OBJ_id_GostR3410_94_CryptoPro_D_ParamSet, NID_id_GostR3410_94_CryptoPro_D_ParamSet );
        OID_TO_NID.put( OBJ_id_GostR3410_94_CryptoPro_XchA_ParamSet, NID_id_GostR3410_94_CryptoPro_XchA_ParamSet );
        OID_TO_NID.put( OBJ_id_GostR3410_94_CryptoPro_XchB_ParamSet, NID_id_GostR3410_94_CryptoPro_XchB_ParamSet );
        OID_TO_NID.put( OBJ_id_GostR3410_94_CryptoPro_XchC_ParamSet, NID_id_GostR3410_94_CryptoPro_XchC_ParamSet );
        OID_TO_NID.put( OBJ_id_GostR3410_2001_TestParamSet, NID_id_GostR3410_2001_TestParamSet );
        OID_TO_NID.put( OBJ_id_GostR3410_2001_CryptoPro_A_ParamSet, NID_id_GostR3410_2001_CryptoPro_A_ParamSet );
        OID_TO_NID.put( OBJ_id_GostR3410_2001_CryptoPro_B_ParamSet, NID_id_GostR3410_2001_CryptoPro_B_ParamSet );
        OID_TO_NID.put( OBJ_id_GostR3410_2001_CryptoPro_C_ParamSet, NID_id_GostR3410_2001_CryptoPro_C_ParamSet );
        OID_TO_NID.put( OBJ_id_GostR3410_2001_CryptoPro_XchA_ParamSet, NID_id_GostR3410_2001_CryptoPro_XchA_ParamSet );
        OID_TO_NID.put( OBJ_id_GostR3410_2001_CryptoPro_XchB_ParamSet, NID_id_GostR3410_2001_CryptoPro_XchB_ParamSet );
        OID_TO_NID.put( OBJ_id_GostR3410_94_a, NID_id_GostR3410_94_a );
        OID_TO_NID.put( OBJ_id_GostR3410_94_aBis, NID_id_GostR3410_94_aBis );
        OID_TO_NID.put( OBJ_id_GostR3410_94_b, NID_id_GostR3410_94_b );
        OID_TO_NID.put( OBJ_id_GostR3410_94_bBis, NID_id_GostR3410_94_bBis );
        OID_TO_NID.put( OBJ_id_Gost28147_89_cc, NID_id_Gost28147_89_cc );
        OID_TO_NID.put( OBJ_id_GostR3410_94_cc, NID_id_GostR3410_94_cc );
        OID_TO_NID.put( OBJ_id_GostR3410_2001_cc, NID_id_GostR3410_2001_cc );
        OID_TO_NID.put( OBJ_id_GostR3411_94_with_GostR3410_94_cc, NID_id_GostR3411_94_with_GostR3410_94_cc );
        OID_TO_NID.put( OBJ_id_GostR3411_94_with_GostR3410_2001_cc, NID_id_GostR3411_94_with_GostR3410_2001_cc );
        OID_TO_NID.put( OBJ_id_GostR3410_2001_ParamSet_cc, NID_id_GostR3410_2001_ParamSet_cc );
        OID_TO_NID.put( OBJ_camellia_128_cbc, NID_camellia_128_cbc );
        OID_TO_NID.put( OBJ_camellia_192_cbc, NID_camellia_192_cbc );
        OID_TO_NID.put( OBJ_camellia_256_cbc, NID_camellia_256_cbc );
        OID_TO_NID.put( OBJ_id_camellia128_wrap, NID_id_camellia128_wrap );
        OID_TO_NID.put( OBJ_id_camellia192_wrap, NID_id_camellia192_wrap );
        OID_TO_NID.put( OBJ_id_camellia256_wrap, NID_id_camellia256_wrap );
        OID_TO_NID.put( OBJ_camellia_128_ecb, NID_camellia_128_ecb );
        OID_TO_NID.put( OBJ_camellia_128_ofb128, NID_camellia_128_ofb128 );
        OID_TO_NID.put( OBJ_camellia_128_cfb128, NID_camellia_128_cfb128 );
        OID_TO_NID.put( OBJ_camellia_192_ecb, NID_camellia_192_ecb );
        OID_TO_NID.put( OBJ_camellia_192_ofb128, NID_camellia_192_ofb128 );
        OID_TO_NID.put( OBJ_camellia_192_cfb128, NID_camellia_192_cfb128 );
        OID_TO_NID.put( OBJ_camellia_256_ecb, NID_camellia_256_ecb );
        OID_TO_NID.put( OBJ_camellia_256_ofb128, NID_camellia_256_ofb128 );
        OID_TO_NID.put( OBJ_camellia_256_cfb128, NID_camellia_256_cfb128 );
        OID_TO_NID.put( OBJ_kisa, NID_kisa );
        OID_TO_NID.put( OBJ_seed_ecb, NID_seed_ecb );
        OID_TO_NID.put( OBJ_seed_cbc, NID_seed_cbc );
        OID_TO_NID.put( OBJ_seed_cfb128, NID_seed_cfb128 );
        OID_TO_NID.put( OBJ_seed_ofb128, NID_seed_ofb128 );
        OID_TO_NID.put( OBJ_dhpublicnumber, NID_dhpublicnumber );
        OID_TO_NID.put( OBJ_brainpoolP160r1, NID_brainpoolP160r1 );
        OID_TO_NID.put( OBJ_brainpoolP160t1, NID_brainpoolP160t1 );
        OID_TO_NID.put( OBJ_brainpoolP192r1, NID_brainpoolP192r1 );
        OID_TO_NID.put( OBJ_brainpoolP192t1, NID_brainpoolP192t1 );
        OID_TO_NID.put( OBJ_brainpoolP224r1, NID_brainpoolP224r1 );
        OID_TO_NID.put( OBJ_brainpoolP224t1, NID_brainpoolP224t1 );
        OID_TO_NID.put( OBJ_brainpoolP256r1, NID_brainpoolP256r1 );
        OID_TO_NID.put( OBJ_brainpoolP256t1, NID_brainpoolP256t1 );
        OID_TO_NID.put( OBJ_brainpoolP320r1, NID_brainpoolP320r1 );
        OID_TO_NID.put( OBJ_brainpoolP320t1, NID_brainpoolP320t1 );
        OID_TO_NID.put( OBJ_brainpoolP384r1, NID_brainpoolP384r1 );
        OID_TO_NID.put( OBJ_brainpoolP384t1, NID_brainpoolP384t1 );
        OID_TO_NID.put( OBJ_brainpoolP512r1, NID_brainpoolP512r1 );
        OID_TO_NID.put( OBJ_brainpoolP512t1, NID_brainpoolP512t1 );
        OID_TO_NID.put( OBJ_dhSinglePass_stdDH_sha1kdf_scheme, NID_dhSinglePass_stdDH_sha1kdf_scheme );
        OID_TO_NID.put( OBJ_dhSinglePass_stdDH_sha224kdf_scheme, NID_dhSinglePass_stdDH_sha224kdf_scheme );
        OID_TO_NID.put( OBJ_dhSinglePass_stdDH_sha256kdf_scheme, NID_dhSinglePass_stdDH_sha256kdf_scheme );
        OID_TO_NID.put( OBJ_dhSinglePass_stdDH_sha384kdf_scheme, NID_dhSinglePass_stdDH_sha384kdf_scheme );
        OID_TO_NID.put( OBJ_dhSinglePass_stdDH_sha512kdf_scheme, NID_dhSinglePass_stdDH_sha512kdf_scheme );
        OID_TO_NID.put( OBJ_dhSinglePass_cofactorDH_sha1kdf_scheme, NID_dhSinglePass_cofactorDH_sha1kdf_scheme );
        OID_TO_NID.put( OBJ_dhSinglePass_cofactorDH_sha224kdf_scheme, NID_dhSinglePass_cofactorDH_sha224kdf_scheme );
        OID_TO_NID.put( OBJ_dhSinglePass_cofactorDH_sha256kdf_scheme, NID_dhSinglePass_cofactorDH_sha256kdf_scheme );
        OID_TO_NID.put( OBJ_dhSinglePass_cofactorDH_sha384kdf_scheme, NID_dhSinglePass_cofactorDH_sha384kdf_scheme );
        OID_TO_NID.put( OBJ_dhSinglePass_cofactorDH_sha512kdf_scheme, NID_dhSinglePass_cofactorDH_sha512kdf_scheme );
        OID_TO_NID.put( OBJ_ct_precert_scts, NID_ct_precert_scts );
        OID_TO_NID.put( OBJ_ct_precert_poison, NID_ct_precert_poison );
        OID_TO_NID.put( OBJ_ct_precert_signer, NID_ct_precert_signer );
        OID_TO_NID.put( OBJ_ct_cert_scts, NID_ct_cert_scts );
        OID_TO_NID.put( OBJ_jurisdictionLocalityName, NID_jurisdictionLocalityName );
        OID_TO_NID.put( OBJ_jurisdictionStateOrProvinceName, NID_jurisdictionStateOrProvinceName );
        OID_TO_NID.put( OBJ_jurisdictionCountryName, NID_jurisdictionCountryName );
    }
